...
class ResponseDeserialiserDiffblueTest {
   ...
   * <p>
   * Method under test: {@link ResponseDeserialiser#encodeString(String)}
   */
  @Test
  ...
  void testEncodeString() throws UnsupportedEncodingException, SerialisationException {
    // Arrange and Act
    byte[] actualEncodeStringResult = (new OperationsResponseDeserialiser()).encodeString("Json String");

    // Assert
    assertArrayEquals("Json String".getBytes("UTF-8"), actualEncodeStringResult);
  }
}
