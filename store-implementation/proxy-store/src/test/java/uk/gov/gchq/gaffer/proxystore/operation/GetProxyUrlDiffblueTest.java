...
class GetProxyUrlDiffblueTest {
   ...
   * <p>
   * Method under test: {@link GetProxyUrl#getOutputTypeReference()}
   */
  @Test
   ...
   * <p>
   * Method under test: {@link GetProxyUrl#shallowClone()}
   */
  @Test
  ...
  void testShallowClone() throws CloneFailedException {
    ...
    // Act and Assert
    assertEquals(getProxyUrl, getProxyUrl.shallowClone());
  }
  ...
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(expectedHashCodeResult, getProxyUrl2.hashCode());
  }
   ...
   * </ul>
   * <p>
   * Method under test: {@link GetProxyUrl#equals(Object)}
   */
  @Test
