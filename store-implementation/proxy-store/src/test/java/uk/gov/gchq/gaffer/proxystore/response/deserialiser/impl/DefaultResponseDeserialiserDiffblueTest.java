...
class DefaultResponseDeserialiserDiffblueTest {
   ...
   *   <li>Then return {@code Json String}.</li>
   * </ul>
   * <p>
   * Method under test: {@link DefaultResponseDeserialiser#deserialise(String)}
   */
  @Test
  ...
  void testDeserialise_whenJsonString_thenReturnJsonString() throws SerialisationException {
    // Arrange
    DefaultResponseDeserialiser<Object> defaultResponseDeserialiser = new DefaultResponseDeserialiser<>(
        new TypeReferenceImpl.Object());
