...
class CountAllElementsDefaultViewHandlerDiffblueTest {
  /**
   * Test {@link CountAllElementsDefaultViewHandler#doOperation(CountAllElementsDefaultView, Context, Store)} with {@code operation}, {@code context}, {@code store}.
   * <p>
   * Method under test: {@link CountAllElementsDefaultViewHandler#doOperation(CountAllElementsDefaultView, Context, Store)}
   */
  @Test
  @DisplayName("Test doOperation(CountAllElementsDefaultView, Context, Store) with 'operation', 'context', 'store'")
  ...
  void testDoOperationWithOperationContextStore() throws OperationException {
    // Arrange
    CountAllElementsDefaultViewHandler countAllElementsDefaultViewHandler = new CountAllElementsDefaultViewHandler();
    ...
    // Act
    Long actualDoOperationResult = countAllElementsDefaultViewHandler.doOperation(operation, context, store);
   ...
   * Test {@link CountAllElementsDefaultViewHandler#doOperation(CountAllElementsDefaultView, Context, Store)} with {@code operation}, {@code context}, {@code store}.
   * <ul>
   *   <li>Then calls {@link MapImpl#getAllAggElements(Set)}.</li>
   * </ul>
   * <p>
   * Method under test: {@link CountAllElementsDefaultViewHandler#doOperation(CountAllElementsDefaultView, Context, Store)}
   */
  @Test
  @DisplayName("Test doOperation(CountAllElementsDefaultView, Context, Store) with 'operation', 'context', 'store'; then calls getAllAggElements(Set)")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
      "Long CountAllElementsDefaultViewHandler.doOperation(CountAllElementsDefaultView, Context, Store)"})
  void testDoOperationWithOperationContextStore_thenCallsGetAllAggElements() throws OperationException {
    // Arrange
    CountAllElementsDefaultViewHandler countAllElementsDefaultViewHandler = new CountAllElementsDefaultViewHandler();
    CountAllElementsDefaultView operation = new CountAllElementsDefaultView();
    Context context = new Context();
