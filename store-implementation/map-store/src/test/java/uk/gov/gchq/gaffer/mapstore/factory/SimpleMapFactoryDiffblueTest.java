...
class SimpleMapFactoryDiffblueTest {
   ...
   * <p>
   * Method under test: {@link SimpleMapFactory#getMap(String, Class, Class)}
   */
  @Test
   ...
   * <p>
   * Method under test: {@link SimpleMapFactory#getMultiMap(String, Class, Class)}
   */
  @Test
  ...
  void testGetMultiMap() {
    ...
    // Act
    MultiMap<Object, Object> actualMultiMap = simpleMapFactory.getMultiMap("Map Name", keyClass, valueClass);
   ...
   * </ul>
   * <p>
   * Method under test: {@link SimpleMapFactory#cloneElement(Element, Schema)}
   */
  @Test
