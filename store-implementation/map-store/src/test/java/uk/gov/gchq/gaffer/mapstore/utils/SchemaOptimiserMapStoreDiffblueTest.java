...
class SchemaOptimiserMapStoreDiffblueTest {
   ...
   * </ul>
   *
   * <p>Method under test: {@link SchemaOptimiserMapStore#getDefaultVertexSerialiser(Schema,
   * boolean)}
   */
  @Test
  @DisplayName(
   ...
   *
   * <p>Method under test: default or parameterless constructor of {@link SchemaOptimiserMapStore}
   */
  @Test
