...
class GetElementsUtilDiffblueTest {
  /**
   * Test {@link GetElementsUtil#getRelevantElements(MapImpl, ElementId, View, DirectedType, IncludeIncomingOutgoingType)} with {@code mapImpl}, {@code elementId}, {@code view}, {@code directedType}, {@code inOutType}.
   * <p>
   * Method under test: {@link GetElementsUtil#getRelevantElements(MapImpl, ElementId, View, DirectedType, IncludeIncomingOutgoingType)}
   */
  @Test
  @DisplayName("Test getRelevantElements(MapImpl, ElementId, View, DirectedType, IncludeIncomingOutgoingType) with 'mapImpl', 'elementId', 'view', 'directedType', 'inOutType'")
  ...
  void testGetRelevantElementsWithMapImplElementIdViewDirectedTypeInOutType() {
    ...
    // Act
    Set<Element> actualRelevantElements = GetElementsUtil.getRelevantElements(mapImpl, elementId, new View(),
        DirectedType.EITHER, IncludeIncomingOutgoingType.EITHER);
  ...
  void testGetRelevantElementsWithMapImplElementIdViewDirectedTypeInOutType3() {
    ...
    Entity elementId = (new Entity.Builder()).group("Group").vertex("Vertex").build();
  ...
  void testGetRelevantElementsWithMapImplElementIdViewDirectedTypeInOutType6() {
    ...
    // Act
    Set<Element> actualRelevantElements = GetElementsUtil.getRelevantElements(mapImpl, elementId, new View(),
        DirectedType.DIRECTED, IncludeIncomingOutgoingType.EITHER);
  ...
  void testGetRelevantElementsWithMapImplElementIdViewDirectedTypeInOutType7() {
    ...
    // Act
    Set<Element> actualRelevantElements = GetElementsUtil.getRelevantElements(mapImpl, elementId, new View(),
        DirectedType.UNDIRECTED, IncludeIncomingOutgoingType.EITHER);
  ...
  void testGetRelevantElementsWithMapImplElementIdViewDirectedTypeInOutType10() {
    ...
    Entity elementId = groupResult.vertex(buildResult).build();
  ...
  void testGetRelevantElementsWithMapImplElementIdViewDirectedTypeInOutType14() {
    ...
    Entity buildResult = (new Entity.Builder()).group("Group").vertex("Vertex").build();
    EdgeSeed elementId = new EdgeSeed(buildResult, "Destination");
   ...
   * </ul>
   * <p>
   * Method under test: {@link GetElementsUtil#applyVisibilityFilter(Stream, Schema, User)}
   */
  @Test
  @DisplayName("Test applyVisibilityFilter(Stream, Schema, User); when User(); then return limit five collect toList Empty")
  @Tag("MaintainedByDiffblue")
  ...
  void testApplyVisibilityFilter_whenUser_thenReturnLimitFiveCollectToListEmpty() {
    ...
    // Act
    Stream<Element> actualApplyVisibilityFilterResult = GetElementsUtil.applyVisibilityFilter(elements, schema,
        new User());
   ...
   * </ul>
   * <p>
   * Method under test: {@link GetElementsUtil#applyDirectedTypeFilter(Stream, boolean, DirectedType)}
   */
  @Test
  @DisplayName("Test applyDirectedTypeFilter(Stream, boolean, DirectedType); when 'DIRECTED'")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"Stream GetElementsUtil.applyDirectedTypeFilter(Stream, boolean, DirectedType)"})
  void testApplyDirectedTypeFilter_whenDirected() {
    ...
    // Act
    Stream<Element> actualApplyDirectedTypeFilterResult = GetElementsUtil.applyDirectedTypeFilter(elements, true,
  ...
  void testApplyDirectedTypeFilter_whenFalse() {
    ...
    // Act
    Stream<Element> actualApplyDirectedTypeFilterResult = GetElementsUtil.applyDirectedTypeFilter(elements, false,
        DirectedType.EITHER);
  ...
  /**
   * Test {@link GetElementsUtil#applyView(Stream, Schema, View, boolean)} with {@code elementStream}, {@code schema}, {@code view}, {@code includeMatchedVertex}.
   * <p>
   * Method under test: {@link GetElementsUtil#applyView(Stream, Schema, View, boolean)}
   */
  @Test
  @DisplayName("Test applyView(Stream, Schema, View, boolean) with 'elementStream', 'schema', 'view', 'includeMatchedVertex'")
  @Tag("MaintainedByDiffblue")
  ...
  void testApplyViewWithElementStreamSchemaViewIncludeMatchedVertex() {
    ...
    // Act
    Stream<Element> actualApplyViewResult = GetElementsUtil.applyView(elementStream, schema, new View(), true);
  ...
  /**
   * Test {@link GetElementsUtil#applyView(Stream, Schema, View)} with {@code elementStream}, {@code schema}, {@code view}.
   * <ul>
   *   <li>Then return limit five collect toList Empty.</li>
   * </ul>
   * <p>
   * Method under test: {@link GetElementsUtil#applyView(Stream, Schema, View)}
   */
  @Test
  @DisplayName("Test applyView(Stream, Schema, View) with 'elementStream', 'schema', 'view'; then return limit five collect toList Empty")
  @Tag("MaintainedByDiffblue")
  ...
  void testApplyViewWithElementStreamSchemaView_thenReturnLimitFiveCollectToListEmpty() {
    ...
    // Act
    Stream<Element> actualApplyViewResult = GetElementsUtil.applyView(elementStream, schema, new View());
