...
class FederatedStoreCacheTransientDiffblueTest {
  /**
   * Test {@link FederatedStoreCacheTransient#getCacheNameFrom(String)} with {@code suffixFederatedStoreCacheName}.
   * <p>
   * Method under test: {@link FederatedStoreCacheTransient#getCacheNameFrom(String)}
   */
  @Test
   ...
   * <p>
   * Method under test: {@link FederatedStoreCacheTransient#getSuffixCacheName()}
   */
  @Test
  ...
  void testGetSuffixCacheName() {
    // Arrange, Act and Assert
    assertEquals("suffix federated store cache name",
