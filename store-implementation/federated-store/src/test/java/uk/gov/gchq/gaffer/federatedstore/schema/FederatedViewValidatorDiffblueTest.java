...
class FederatedViewValidatorDiffblueTest {
   ...
   * </ul>
   * <p>
   * Method under test: {@link FederatedViewValidator#validate(View, Schema, Set)}
   */
  @Test
  ...
  void testValidate_givenIngestAggregation_whenHashSetAddIngestAggregation() {
    ...
    // Act
    ValidationResult actualValidateResult = federatedViewValidator.validate(view, schema, storeTraits);
  ...
  void testValidate_whenHashSet() {
    ...
    // Act
    ValidationResult actualValidateResult = federatedViewValidator.validate(view, schema, new HashSet<>());
  ...
  void testValidate_whenNull() {
    ...
    // Act
    ValidationResult actualValidateResult = federatedViewValidator.validate(null, schema, new HashSet<>());
   ...
   * </ul>
   * <p>
   * Method under test: {@link FederatedViewValidator#getEdgeResult(View, Schema, Set, boolean)}
   */
  @Test
  @DisplayName("Test getEdgeResult(View, Schema, Set, boolean); given 'INGEST_AGGREGATION'; when HashSet() add 'INGEST_AGGREGATION'")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"ValidationResult FederatedViewValidator.getEdgeResult(View, Schema, Set, boolean)"})
  void testGetEdgeResult_givenIngestAggregation_whenHashSetAddIngestAggregation() {
    ...
    // Act
    ValidationResult actualEdgeResult = federatedViewValidator.getEdgeResult(view, schema, storeTraits, true);
   ...
   */
  @Test
  @DisplayName("Test getEdgeResult(View, Schema, Set, boolean); given 'QUERY_AGGREGATION'; when HashSet() add 'QUERY_AGGREGATION'")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"ValidationResult FederatedViewValidator.getEdgeResult(View, Schema, Set, boolean)"})
   ...
   */
  @Test
  @DisplayName("Test getEdgeResult(View, Schema, Set, boolean); when HashSet(); then return ErrorString is 'Validation errors:'")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"ValidationResult FederatedViewValidator.getEdgeResult(View, Schema, Set, boolean)"})
  void testGetEdgeResult_whenHashSet_thenReturnErrorStringIsValidationErrors() {
    ...
    // Act
    ValidationResult actualEdgeResult = federatedViewValidator.getEdgeResult(view, schema, new HashSet<>(), true);
   ...
   * </ul>
   * <p>
   * Method under test: {@link FederatedViewValidator#getEntityResult(View, Schema, Set, boolean)}
   */
  @Test
  @DisplayName("Test getEntityResult(View, Schema, Set, boolean); given 'INGEST_AGGREGATION'; when HashSet() add 'INGEST_AGGREGATION'")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"ValidationResult FederatedViewValidator.getEntityResult(View, Schema, Set, boolean)"})
  void testGetEntityResult_givenIngestAggregation_whenHashSetAddIngestAggregation() {
    ...
    // Act
    ValidationResult actualEntityResult = federatedViewValidator.getEntityResult(view, schema, storeTraits, true);
   ...
   */
  @Test
  @DisplayName("Test getEntityResult(View, Schema, Set, boolean); given 'QUERY_AGGREGATION'; when HashSet() add 'QUERY_AGGREGATION'")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"ValidationResult FederatedViewValidator.getEntityResult(View, Schema, Set, boolean)"})
   ...
   */
  @Test
  @DisplayName("Test getEntityResult(View, Schema, Set, boolean); when HashSet(); then return ErrorString is 'Validation errors:'")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"ValidationResult FederatedViewValidator.getEntityResult(View, Schema, Set, boolean)"})
  void testGetEntityResult_whenHashSet_thenReturnErrorStringIsValidationErrors() {
    ...
    // Act
    ValidationResult actualEntityResult = federatedViewValidator.getEntityResult(view, schema, new HashSet<>(), true);
