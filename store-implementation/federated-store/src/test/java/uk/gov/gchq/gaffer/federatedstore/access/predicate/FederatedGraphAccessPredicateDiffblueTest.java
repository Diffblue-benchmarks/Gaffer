...
class FederatedGraphAccessPredicateDiffblueTest {
   ...
   * </ul>
   * <p>
   * Method under test: {@link FederatedGraphAccessPredicate#isAdministrator(User, String)}
   */
  @Test
  ...
  void testIsAdministrator_whenEmptyString() {
    // Arrange
    FederatedGraphWriteAccessPredicate federatedGraphWriteAccessPredicate = new FederatedGraphWriteAccessPredicate(
        "42");
