...
class FederatedOutputHandlerDiffblueTest {
   ...
   * <ul>
   *   <li>When {@link AccumuloStore} (default constructor).</li>
   * </ul>
   * <p>
   * Method under test: {@link FederatedOutputHandler#doOperation(Output, Context, Store)}
   */
  @Test
  @DisplayName("Test doOperation(Output, Context, Store) with 'Output', 'Context', 'Store'; when AccumuloStore (default constructor)")
   ...
   */
  @Test
  @DisplayName("Test doOperation(Output, Context, Store) with 'Output', 'Context', 'Store'; when 'null'; then throw OperationException")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"Object FederatedOutputHandler.doOperation(Output, Context, Store)"})
  void testDoOperationWithOutputContextStore_whenNull_thenThrowOperationException() throws OperationException {
    // Arrange
    FederatedOutputHandler<Output<Object>, Object> federatedOutputHandler = new FederatedOutputHandler<>();
    Context context = new Context();
    ...
    // Act and Assert
    assertThrows(OperationException.class,
        () -> federatedOutputHandler.doOperation(null, context, new FederatedStore()));
  }
}
