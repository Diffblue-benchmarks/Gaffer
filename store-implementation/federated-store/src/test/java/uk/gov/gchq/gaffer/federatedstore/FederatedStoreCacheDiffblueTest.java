...
class FederatedStoreCacheDiffblueTest {
   ...
   * <p>
   * Method under test: {@link FederatedStoreCache#FederatedStoreCache(String)}
   */
  @Test
  ...
  void testNewFederatedStoreCache() {
    // Arrange and Act
    FederatedStoreCache actualFederatedStoreCache = new FederatedStoreCache("Suffix Federated Store Cache Name");

    // Assert
    assertEquals("federatedStoreGraphs_suffix federated store cache name", actualFederatedStoreCache.getCacheName());
   ...
   * <p>
   * Method under test: {@link FederatedStoreCache#getCacheName()}
   */
  @Test
  ...
  void testGetCacheName() {
    ...
    assertEquals("federatedStoreGraphs_suffix federated store cache name",
   ...
   * <p>
   * Method under test: {@link FederatedStoreCache#getCache()}
   */
  @Test
   ...
   * <p>
   * Method under test: {@link FederatedStoreCache#getCacheNameFrom(String)}
   */
  @Test
  ...
  void testGetCacheNameFrom() {
    // Arrange, Act and Assert
    assertEquals("federatedStoreGraphs_suffix cache name", FederatedStoreCache.getCacheNameFrom("Suffix Cache Name"));
  }
}
