...
class AccumuloElementsRetrieverDiffblueTest {
  /**
   * Test {@link AccumuloElementsRetriever#AccumuloElementsRetriever(AccumuloStore, GetElements, User)}.
   * <ul>
   *   <li>Given {@link Schema#Schema()}.</li>
   *   <li>Then calls {@link AccumuloStore#getKeyPackage()}.</li>
   * </ul>
   * <p>
   * Method under test: {@link AccumuloElementsRetriever#AccumuloElementsRetriever(AccumuloStore, GetElements, User)}
   */
  @Test
  @DisplayName("Test new AccumuloElementsRetriever(AccumuloStore, GetElements, User); given Schema(); then calls getKeyPackage()")
