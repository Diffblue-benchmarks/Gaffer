...
class ElementPostAggregationFilterDiffblueTest {
   ...
   * <p>
   * Method under test: default or parameterless constructor of {@link ElementPostAggregationFilter}
   */
  @Test
  ...
  void testNewElementPostAggregationFilter() {
    ...
    assertEquals("Only returns elements that pass post aggregation validation against the given view",
   ...
   * <p>
   * Method under test: {@link ElementPostAggregationFilter#describeOptions()}
   */
  @Test
  @DisplayName("Test describeOptions()")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"OptionDescriber.IteratorOptions ElementPostAggregationFilter.describeOptions()"})
  void testDescribeOptions() {
    // Arrange and Act
    IteratorOptions actualDescribeOptionsResult = (new ElementPostAggregationFilter()).describeOptions();
