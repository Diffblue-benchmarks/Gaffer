...
class AccumuloAdjacentIdRetrieverDiffblueTest {
  /**
   * Test {@link AccumuloAdjacentIdRetriever#AccumuloAdjacentIdRetriever(AccumuloStore, GetAdjacentIds, User)}.
   * <p>
   * Method under test: {@link AccumuloAdjacentIdRetriever#AccumuloAdjacentIdRetriever(AccumuloStore, GetAdjacentIds, User)}
   */
  @Test
  @DisplayName("Test new AccumuloAdjacentIdRetriever(AccumuloStore, GetAdjacentIds, User)")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void AccumuloAdjacentIdRetriever.<init>(AccumuloStore, GetAdjacentIds, User)"})
  void testNewAccumuloAdjacentIdRetriever()
      throws UnsupportedEncodingException, IteratorSettingException, SchemaException, StoreException {
    // Arrange
    ...
    stringViewElementDefinitionMap.put("Element_Post_Aggregation_Filter", new ViewElementDefinition());
   ...
   */
  @Test
  @DisplayName("Test new AccumuloAdjacentIdRetriever(AccumuloStore, GetAdjacentIds, User); given Schema()")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void AccumuloAdjacentIdRetriever.<init>(AccumuloStore, GetAdjacentIds, User)"})
  void testNewAccumuloAdjacentIdRetriever_givenSchema() throws IteratorSettingException, StoreException {
    // Arrange
    AccumuloStore store = mock(AccumuloStore.class);
   ...
   *   <li>When {@link GetAdjacentIds} {@link GetAdjacentIds#getView()} return {@link View} (default constructor).</li>
   * </ul>
   * <p>
   * Method under test: {@link AccumuloAdjacentIdRetriever#AccumuloAdjacentIdRetriever(AccumuloStore, GetAdjacentIds, User)}
   */
  @Test
  @DisplayName("Test new AccumuloAdjacentIdRetriever(AccumuloStore, GetAdjacentIds, User); given View (default constructor); when GetAdjacentIds getView() return View (default constructor)")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void AccumuloAdjacentIdRetriever.<init>(AccumuloStore, GetAdjacentIds, User)"})
   ...
   */
  @Test
  @DisplayName("Test new AccumuloAdjacentIdRetriever(AccumuloStore, GetAdjacentIds, User); then calls getEdgeGroups()")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void AccumuloAdjacentIdRetriever.<init>(AccumuloStore, GetAdjacentIds, User)"})
   ...
   * Test {@link AccumuloAdjacentIdRetriever#AccumuloAdjacentIdRetriever(AccumuloStore, GetAdjacentIds, User)}.
   * <ul>
   *   <li>Then calls {@link ViewElementDefinition#hasPostTransformFilters()}.</li>
   * </ul>
   * <p>
   * Method under test: {@link AccumuloAdjacentIdRetriever#AccumuloAdjacentIdRetriever(AccumuloStore, GetAdjacentIds, User)}
   */
  @Test
  @DisplayName("Test new AccumuloAdjacentIdRetriever(AccumuloStore, GetAdjacentIds, User); then calls hasPostTransformFilters()")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void AccumuloAdjacentIdRetriever.<init>(AccumuloStore, GetAdjacentIds, User)"})
  void testNewAccumuloAdjacentIdRetriever_thenCallsHasPostTransformFilters()
    ...
    HashMap<String, ViewElementDefinition> stringViewElementDefinitionMap = new HashMap<>();
    stringViewElementDefinitionMap.put("Element_Post_Aggregation_Filter", globalViewElementDefinition);
    View view = mock(View.class);
    when(view.toCompactJson()).thenReturn("AXAXAXAX".getBytes("UTF-8"));
    when(view.hasPostAggregationFilters()).thenReturn(true);
    when(view.hasPreAggregationFilters()).thenReturn(false);
   ...
   */
  @Test
  @DisplayName("Test new AccumuloAdjacentIdRetriever(AccumuloStore, GetAdjacentIds, User); when 'null'; then calls getEdgeGroups()")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void AccumuloAdjacentIdRetriever.<init>(AccumuloStore, GetAdjacentIds, User)"})
  void testNewAccumuloAdjacentIdRetriever_whenNull_thenCallsGetEdgeGroups()
      throws UnsupportedEncodingException, IteratorSettingException, SchemaException, StoreException {
    // Arrange
    Schema schema = mock(Schema.class);
    when(schema.toCompactJson()).thenReturn("AXAXAXAX".getBytes("UTF-8"));
