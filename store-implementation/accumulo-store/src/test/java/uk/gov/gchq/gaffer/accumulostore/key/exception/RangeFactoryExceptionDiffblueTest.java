...
class RangeFactoryExceptionDiffblueTest {
   ...
   * <p>
   * Method under test: {@link RangeFactoryException#RangeFactoryException(String, Throwable)}
   */
  @Test
  ...
  void testNewRangeFactoryException() {
    ...
    // Act
    RangeFactoryException actualRangeFactoryException = new RangeFactoryException("An error occurred", e);
