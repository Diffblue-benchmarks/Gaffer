...
class GafferRangePartitionerDiffblueTest {
  ...
  void testGetPartitionWithTextWritableInt() {
    ...
    // Act and Assert
    assertThrows(RuntimeException.class, () -> gafferRangePartitioner.getPartition(key, value, 10));
  }
   ...
   */
  @Test
  @DisplayName("Test setSplitFile(Job, String)")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void GafferRangePartitioner.setSplitFile(Job, String)"})
  void testSetSplitFile() throws IOException {
    // Arrange
    ...
    assertEquals("File", cacheFiles[0].toString());
    assertEquals(1, cacheFiles.length);
    assertEquals(1449, configuration.size());
  }
   ...
   *
   * <ul>
   *   <li>Then second element toString is {@code File}.
   * </ul>
   *
   * <p>Method under test: {@link GafferRangePartitioner#setSplitFile(Job, String)}
   */
  @Test
  @DisplayName("Test setSplitFile(Job, String); then second element toString is 'File'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void GafferRangePartitioner.setSplitFile(Job, String)"})
  void testSetSplitFile_thenSecondElementToStringIsFile() throws IOException {
    // Arrange
    Job job = new Job();
    job.addCacheFile(Paths.get(System.getProperty("java.io.tmpdir"), "test.txt").toUri());
    ...
    assertTrue(configuration instanceof JobConf);
    URI[] cacheFiles = job.getCacheFiles();
    assertEquals("File", cacheFiles[1].toString());
   ...
   *   <li>Then first element toString is {@code File}.
   * </ul>
   *
   * <p>Method under test: {@link GafferRangePartitioner#setSplitFile(Job, String)}
   */
  @Test
  @DisplayName("Test setSplitFile(Job, String); when Job(); then first element toString is 'File'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void GafferRangePartitioner.setSplitFile(Job, String)"})
  void testSetSplitFile_whenJob_thenFirstElementToStringIsFile() throws IOException {
    // Arrange
    Job job = new Job();
