...
class ByteEntityIteratorSettingsFactoryDiffblueTest {
  ...
  void testGetElementPropertyRangeQueryFilter4() {
    // Arrange
    ByteEntityIteratorSettingsFactory byteEntityIteratorSettingsFactory =
        new ByteEntityIteratorSettingsFactory();
  ...
  @Test
  @DisplayName(
      "Test getElementPropertyRangeQueryFilter(GraphFilters); given View (default constructor); then return Options size is one")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "IteratorSetting ByteEntityIteratorSettingsFactory.getElementPropertyRangeQueryFilter(GraphFilters)"
  })
  void testGetElementPropertyRangeQueryFilter_givenView_thenReturnOptionsSizeIsOne() {
    // Arrange
    ByteEntityIteratorSettingsFactory byteEntityIteratorSettingsFactory =
        new ByteEntityIteratorSettingsFactory();
