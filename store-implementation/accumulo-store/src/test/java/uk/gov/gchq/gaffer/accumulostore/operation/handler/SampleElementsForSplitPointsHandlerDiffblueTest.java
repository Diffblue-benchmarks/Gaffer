...
class SampleElementsForSplitPointsHandlerDiffblueTest {
  /**
   * Test {@link SampleElementsForSplitPointsHandler#getNumSplits(SampleElementsForSplitPoints, AccumuloStore)} with {@code SampleElementsForSplitPoints}, {@code AccumuloStore}.
   * <p>
   * Method under test: {@link SampleElementsForSplitPointsHandler#getNumSplits(SampleElementsForSplitPoints, AccumuloStore)}
   */
  @Test
  @DisplayName("Test getNumSplits(SampleElementsForSplitPoints, AccumuloStore) with 'SampleElementsForSplitPoints', 'AccumuloStore'")
  ...
  void testGetNumSplitsWithSampleElementsForSplitPointsAccumuloStore() {
    // Arrange
    SampleElementsForSplitPointsHandler sampleElementsForSplitPointsHandler = new SampleElementsForSplitPointsHandler();

    SampleElementsForSplitPoints operation = new SampleElementsForSplitPoints();
    operation.setNumSplits(1);

    // Act and Assert
    assertEquals(1, sampleElementsForSplitPointsHandler.getNumSplits(operation, new AccumuloStore()).intValue());
  }

  /**
   * Test new {@link SampleElementsForSplitPointsHandler} (default constructor).
   * <p>
   * Method under test: default or parameterless constructor of {@link SampleElementsForSplitPointsHandler}
   */
  @Test
