...
class AddElementsFromHdfsMapperDiffblueTest {
  /**
   * Test {@link AddElementsFromHdfsMapper#setup(Context)}.
   *
   * <ul>
   *   <li>Then throw {@link IllegalArgumentException}.
   * </ul>
   *
   * <p>Method under test: {@link AddElementsFromHdfsMapper#setup(Context)}
   */
  @Test
  @DisplayName("Test setup(Context); then throw IllegalArgumentException")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void AddElementsFromHdfsMapper.setup(Context)"})
  void testSetup_thenThrowIllegalArgumentException() throws IOException {
    // Arrange
    AddElementsFromHdfsMapper<Object, Object> addElementsFromHdfsMapper =
        new AddElementsFromHdfsMapper<>();
    ...
    assertThrows(
        ...
        () -> addElementsFromHdfsMapper.setup(new WrappedMapper().new Context(mapContext)));
