...
class ElementPreAggregationFilterDiffblueTest {
   ...
   * <p>
   * Method under test: default or parameterless constructor of {@link ElementPreAggregationFilter}
   */
  @Test
  ...
  void testNewElementPreAggregationFilter() {
    ...
    assertEquals("Only returns elements that pass pre aggregation validation against the given view",
   ...
   * <p>
   * Method under test: {@link ElementPreAggregationFilter#describeOptions()}
   */
  @Test
  @DisplayName("Test describeOptions()")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"OptionDescriber.IteratorOptions ElementPreAggregationFilter.describeOptions()"})
  void testDescribeOptions() {
    // Arrange and Act
    IteratorOptions actualDescribeOptionsResult = (new ElementPreAggregationFilter()).describeOptions();
