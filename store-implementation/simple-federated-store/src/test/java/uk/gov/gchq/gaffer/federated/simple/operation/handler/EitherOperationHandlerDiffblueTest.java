...
class EitherOperationHandlerDiffblueTest {
   ...
   *
   * <ul>
   *   <li>Given {@code Checking if Operation should be handled locally or on sub graphs: {}}.
   * </ul>
   *
  ...
  @Test
  @DisplayName(
      "Test doOperation(Operation, Context, Store); given 'Checking if Operation should be handled locally or on sub graphs: {}'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"Object EitherOperationHandler.doOperation(Operation, Context, Store)"})
  void testDoOperation_givenCheckingIfOperationShouldBeHandledLocallyOrOnSubGraphs()
