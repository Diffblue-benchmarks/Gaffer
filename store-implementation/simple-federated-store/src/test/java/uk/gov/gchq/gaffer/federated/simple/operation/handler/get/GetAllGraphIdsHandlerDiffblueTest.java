...
class GetAllGraphIdsHandlerDiffblueTest {
  /**
   * Test {@link GetAllGraphIdsHandler#doOperation(GetAllGraphIds, Context, Store)} with {@code GetAllGraphIds}, {@code Context}, {@code Store}.
   * <ul>
   *   <li>Given {@link ArrayList#ArrayList()}.</li>
   *   <li>Then return Empty.</li>
   * </ul>
   * <p>
   * Method under test: {@link GetAllGraphIdsHandler#doOperation(GetAllGraphIds, Context, Store)}
   */
  @Test
  @DisplayName("Test doOperation(GetAllGraphIds, Context, Store) with 'GetAllGraphIds', 'Context', 'Store'; given ArrayList(); then return Empty")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"Set GetAllGraphIdsHandler.doOperation(GetAllGraphIds, Context, Store)"})
  void testDoOperationWithGetAllGraphIdsContextStore_givenArrayList_thenReturnEmpty() throws OperationException {
    // Arrange
    ...
    // Act
    Set<String> actualDoOperationResult = getAllGraphIdsHandler.doOperation(operation, context, store);
