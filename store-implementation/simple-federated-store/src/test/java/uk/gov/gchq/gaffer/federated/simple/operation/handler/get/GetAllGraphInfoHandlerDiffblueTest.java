...
class GetAllGraphInfoHandlerDiffblueTest {
  /**
   * Test {@link GetAllGraphInfoHandler#doOperation(GetAllGraphInfo, Context, Store)} with {@code GetAllGraphInfo}, {@code Context}, {@code Store}.
   * <ul>
   *   <li>Then return size is one.</li>
   * </ul>
   * <p>
   * Method under test: {@link GetAllGraphInfoHandler#doOperation(GetAllGraphInfo, Context, Store)}
   */
  @Test
  @DisplayName("Test doOperation(GetAllGraphInfo, Context, Store) with 'GetAllGraphInfo', 'Context', 'Store'; then return size is one")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"Map GetAllGraphInfoHandler.doOperation(GetAllGraphInfo, Context, Store)"})
  void testDoOperationWithGetAllGraphInfoContextStore_thenReturnSizeIsOne() throws OperationException {
    // Arrange
    ...
    // Act
    Map<String, Object> actualDoOperationResult = getAllGraphInfoHandler.doOperation(operation, context, store);
