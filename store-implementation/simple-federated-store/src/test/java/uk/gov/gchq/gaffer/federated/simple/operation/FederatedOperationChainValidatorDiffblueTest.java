...
class FederatedOperationChainValidatorDiffblueTest {
   ...
   */
  @Test
  @DisplayName("Test getSchema(Operation, User, Store); when AddGraph (default constructor); then return 'null'")
   ...
   */
  @Test
  @DisplayName("Test getSchema(Operation, User, Store); when OperationChain(); then return 'null'")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
      "uk.gov.gchq.gaffer.store.schema.Schema FederatedOperationChainValidator.getSchema(Operation, User, Store)"})
  void testGetSchema_whenOperationChain_thenReturnNull() {
    // Arrange
    FederatedOperationChainValidator federatedOperationChainValidator = new FederatedOperationChainValidator(
        new ViewValidator());
