...
class ToTypeSubTypeValueDiffblueTest {
   ...
   * <p>
   * Method under test: {@link ToTypeSubTypeValue#ToTypeSubTypeValue(String, String)}
   */
  @Test
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"String ToTypeSubTypeValue.getSubType()", "String ToTypeSubTypeValue.getType()",
      "void ToTypeSubTypeValue.setSubType(String)", "void ToTypeSubTypeValue.setType(String)"})
