...
class TypeSubTypeValueDiffblueTest {
  ...
  @MethodsUnderTest({"void TypeSubTypeValue.<init>()", "void TypeSubTypeValue.<init>(String, String, String)",
      "String TypeSubTypeValue.getSubType()", "String TypeSubTypeValue.getType()", "String TypeSubTypeValue.getValue()",
      "void TypeSubTypeValue.setSubType(String)", "void TypeSubTypeValue.setType(String)",
      "void TypeSubTypeValue.setValue(String)", "String TypeSubTypeValue.toString()"})
  ...
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(expectedHashCodeResult, typeSubTypeValue2.hashCode());
  }
   ...
   */
  @Test
  @DisplayName("Test compareTo(TypeSubTypeValue) with 'TypeSubTypeValue'; when 'null'; then return one")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"int TypeSubTypeValue.compareTo(TypeSubTypeValue)"})
