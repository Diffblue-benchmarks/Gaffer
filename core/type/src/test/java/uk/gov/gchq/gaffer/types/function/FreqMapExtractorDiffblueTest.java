...
class FreqMapExtractorDiffblueTest {
  ...
  @MethodsUnderTest({"void FreqMapExtractor.<init>()", "void FreqMapExtractor.<init>(String)",
      "String FreqMapExtractor.getKey()", "void FreqMapExtractor.setKey(String)"})
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"java.lang.Long FreqMapExtractor.apply(FreqMap)"})
