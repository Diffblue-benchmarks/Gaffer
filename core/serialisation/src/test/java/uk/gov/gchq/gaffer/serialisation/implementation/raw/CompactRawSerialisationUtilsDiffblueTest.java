...
class CompactRawSerialisationUtilsDiffblueTest {
   ...
   *
   * <ul>
   *   <li>Then return array of {@code byte} with minus one hundred twelve.
   * </ul>
   *
   * <p>Method under test: {@link CompactRawSerialisationUtils#writeLong(long)}
   */
  @Test
   ...
   *
   * <ul>
   *   <li>Then return array of {@code byte} with minus one hundred twenty and one.
   * </ul>
   *
   * <p>Method under test: {@link CompactRawSerialisationUtils#writeLong(long)}
   */
  @Test
  @DisplayName(
      "Test writeLong(long); then return array of byte with minus one hundred twenty and one")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"byte[] CompactRawSerialisationUtils.writeLong(long)"})
  void testWriteLong_thenReturnArrayOfByteWithMinusOneHundredTwentyAndOne() {
    // Arrange, Act and Assert
    assertArrayEquals(
        new byte[] {-120, 1, '#', 'E', 'g', -119, -85, -51, -17},
  ...
  @Test
  @DisplayName(
      "Test writeLong(long); then return array of byte with minus one hundred twenty-one and 'p'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"byte[] CompactRawSerialisationUtils.writeLong(long)"})
  ...
  /**
   * Test {@link CompactRawSerialisationUtils#readLong(byte[], int)} with {@code allBytes}, {@code
   * offset}.
   *
   * <ul>
   ...
   * </ul>
   *
   * <p>Method under test: {@link CompactRawSerialisationUtils#readLong(byte[], int)}
   */
  @Test
  @DisplayName(
      "Test readLong(byte[], int) with 'allBytes', 'offset'; when 'AXAXAXAX' Bytes is 'UTF-8'; then return sixty-five")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
   ...
   * </ul>
   *
   * <p>Method under test: {@link CompactRawSerialisationUtils#readLong(byte[])}
   */
  @Test
  @DisplayName(
      "Test readLong(byte[]) with 'bytes'; when 'AXAXAXAX' Bytes is 'UTF-8'; then return sixty-five")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
   ...
   *
   * <p>Method under test: {@link CompactRawSerialisationUtils#write(long, OutputStream)}
   */
  @Test
  ...
  void testWrite() throws SerialisationException {
    ...
    // Assert
    assertArrayEquals(
        new byte[] {-120, 1, '#', 'E', 'g', -119, -85, -51, -17}, output.toByteArray());
  }
  ...
  @Test
  @DisplayName(
      "Test write(long, OutputStream); when PipedOutputStream(); then throw SerialisationException")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void CompactRawSerialisationUtils.write(long, OutputStream)"})
  void testWrite_whenPipedOutputStream_thenThrowSerialisationException()
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void CompactRawSerialisationUtils.write(long, OutputStream)"})
  void testWrite_whenPipedOutputStream_thenThrowSerialisationException2()
      throws SerialisationException {
    // Arrange, Act and Assert
    assertThrows(
        SerialisationException.class,
   ...
   *       with {@link Byte#MIN_VALUE} and {@code X} read is minus one.
   * </ul>
   *
   * <p>Method under test: {@link CompactRawSerialisationUtils#read(InputStream)}
   */
  @Test
  @DisplayName(
      "Test read(InputStream); then ByteArrayInputStream(byte[]) with array of byte with MIN_VALUE and 'X' read is minus one")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"long CompactRawSerialisationUtils.read(InputStream)"})
  void testRead_thenByteArrayInputStreamWithArrayOfByteWithMin_valueAndXReadIsMinusOne()
      throws IOException {
    // Arrange
    ...
    // Assert
    int actualReadResult2 = input.read(new byte[] {});
  ...
  @Test
  @DisplayName(
      "Test read(InputStream); when ByteArrayInputStream(byte[]) with 'AXAXAXAX' Bytes is 'UTF-8'; then return sixty-five")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"long CompactRawSerialisationUtils.read(InputStream)"})
  void testRead_whenByteArrayInputStreamWithAxaxaxaxBytesIsUtf8_thenReturnSixtyFive()
      throws IOException {
    // Arrange
   ...
   * </ul>
   *
   * <p>Method under test: {@link CompactRawSerialisationUtils#decodeVIntSize(byte)}
   */
  @Test
   ...
   *
   * <ul>
   *   <li>When minus one hundred thirteen.
   *   <li>Then return two.
   * </ul>
   *
   * <p>Method under test: {@link CompactRawSerialisationUtils#decodeVIntSize(byte)}
   ...
   *
   * <ul>
   *   <li>When minus one hundred twenty-one.
   *   <li>Then return two.
   * </ul>
   *
   * <p>Method under test: {@link CompactRawSerialisationUtils#decodeVIntSize(byte)}
