...
class ToBytesSerialiserDiffblueTest {
  ...
  /**
   * Test {@link ToBytesSerialiser#deserialise(byte[], int, int)} with {@code byte[]}, {@code int}, {@code int}.
   * <ul>
   ...
   */
  @Test
  @DisplayName("Test deserialise(byte[], int, int) with 'byte[]', 'int', 'int'; when 'AXAXAXAX' Bytes is 'UTF-8'; then return 'AXA' Bytes is 'UTF-8'")
  @Tag("MaintainedByDiffblue")
