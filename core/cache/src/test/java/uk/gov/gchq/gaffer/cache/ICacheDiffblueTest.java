...
class ICacheDiffblueTest {
   ...
   *   <li>Then {@link HashMapCache#HashMapCache()} AllValues size is one.</li>
   * </ul>
   * <p>
   * Method under test: {@link ICache#putSafe(Object, Object)}
   */
  @Test
  @DisplayName("Test putSafe(Object, Object); given HashMapCache(); then HashMapCache() AllValues size is one")
   ...
   * Test {@link ICache#putSafe(Object, Object)}.
   * <ul>
   *   <li>Then throw {@link OverwritingException}.</li>
   * </ul>
   * <p>
   * Method under test: {@link ICache#putSafe(Object, Object)}
   */
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void ICache.putSafe(Object, Object)"})
  void testPutSafe_thenThrowOverwritingException() throws CacheOperationException, OverwritingException {
    // Arrange
   ...
   * <p>
   * Method under test: {@link ICache#size()}
   */
  @Test
