...
class UnrestrictedAccessUserPredicateDiffblueTest {
   ...
   * <p>
   * Method under test: {@link UnrestrictedAccessUserPredicate#test(User)}
   */
  @Test
  ...
  void testTestWithUser() {
    // Arrange
    UnrestrictedAccessUserPredicate unrestrictedAccessUserPredicate = new UnrestrictedAccessUserPredicate();
