...
class AddOperationsToChainDiffblueTest {
   ...
   */
  @Test
  @DisplayName("Test preExecute(OperationChain, Context); when 'null'; then does not throw")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void AddOperationsToChain.preExecute(OperationChain, Context)"})
  void testPreExecute_whenNull_thenDoesNotThrow() {
    // Arrange
    AddOperationsToChain addOperationsToChain = new AddOperationsToChain();

    // Act and Assert
    assertDoesNotThrow(() -> addOperationsToChain.preExecute(null, new Context()));
  }
  ...
  @Test
  @DisplayName(
      "Test preExecute(OperationChain, Context); when OperationChain(); then does not throw")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void AddOperationsToChain.preExecute(OperationChain, Context)"})
  void testPreExecute_whenOperationChain_thenDoesNotThrow() {
    // Arrange
    AddOperationsToChain addOperationsToChain = new AddOperationsToChain();
    OperationChain<Object> opChain = new OperationChain<>();

    // Act and Assert
    assertDoesNotThrow(() -> addOperationsToChain.preExecute(opChain, new Context()));
  }
