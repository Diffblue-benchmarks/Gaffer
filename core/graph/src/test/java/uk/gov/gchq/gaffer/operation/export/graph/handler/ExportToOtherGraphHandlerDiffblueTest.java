...
class ExportToOtherGraphHandlerDiffblueTest {
  ...
  @MethodsUnderTest({"void ExportToOtherGraphHandler.<init>()", "Class ExportToOtherGraphHandler.getExporterClass()"})
  void testGettersAndSetters() {
    // Arrange and Act
    Class<OtherGraphExporter> actualExporterClass = (new ExportToOtherGraphHandler()).getExporterClass();
