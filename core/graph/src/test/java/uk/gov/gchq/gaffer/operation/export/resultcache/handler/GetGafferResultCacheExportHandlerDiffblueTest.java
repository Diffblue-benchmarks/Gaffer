...
class GetGafferResultCacheExportHandlerDiffblueTest {
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void GetGafferResultCacheExportHandler.<init>()",
  ...
  void testGettersAndSetters() {
    // Arrange and Act
    GetGafferResultCacheExportHandler actualGetGafferResultCacheExportHandler =
        new GetGafferResultCacheExportHandler();
    ...
    Class<GafferResultCacheExporter> actualExporterClass =
        actualGetGafferResultCacheExportHandler.getExporterClass();
    String actualGraphId = actualGetGafferResultCacheExportHandler.getGraphId();
    String actualStorePropertiesPath =
        actualGetGafferResultCacheExportHandler.getStorePropertiesPath();
