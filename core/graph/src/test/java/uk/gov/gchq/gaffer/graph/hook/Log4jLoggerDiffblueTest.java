...
class Log4jLoggerDiffblueTest {
   ...
   * <p>
   * Method under test: {@link Log4jLogger#postExecute(Object, OperationChain, Context)}
   */
  @Test
   ...
   * <p>
   * Method under test: {@link Log4jLogger#onFailure(Object, OperationChain, Context, Exception)}
   */
  @Test
