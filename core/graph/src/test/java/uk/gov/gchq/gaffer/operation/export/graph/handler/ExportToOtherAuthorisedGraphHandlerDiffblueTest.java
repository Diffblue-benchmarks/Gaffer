...
class ExportToOtherAuthorisedGraphHandlerDiffblueTest {
   ...
   * <ul>
   *   <li>Then {@link ExportToOtherAuthorisedGraphHandler} (default constructor) IdAuths is {@link HashMap#HashMap()}.</li>
   * </ul>
   * <p>
   * Method under test: {@link ExportToOtherAuthorisedGraphHandler#setIdAuths(Map)}
   */
  @Test
  @DisplayName("Test setIdAuths(Map); then ExportToOtherAuthorisedGraphHandler (default constructor) IdAuths is HashMap()")
   ...
   *   <li>Then {@link ExportToOtherAuthorisedGraphHandler} (default constructor) IdAuths Empty.</li>
   * </ul>
   * <p>
   * Method under test: {@link ExportToOtherAuthorisedGraphHandler#setIdAuths(Map)}
   */
  @Test
  @DisplayName("Test setIdAuths(Map); when 'null'; then ExportToOtherAuthorisedGraphHandler (default constructor) IdAuths Empty")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void ExportToOtherAuthorisedGraphHandler.setIdAuths(Map)"})
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void ExportToOtherAuthorisedGraphHandler.<init>()",
