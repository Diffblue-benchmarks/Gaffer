...
class NamedViewResolverDiffblueTest {
   ...
   * <p>
   * Method under test: {@link NamedViewResolver#NamedViewResolver(NamedViewCache)}
   */
  @Test
   ...
   * <p>
   * Method under test: {@link NamedViewResolver#NamedViewResolver(String)}
   */
  @Test
   ...
   * <p>
   * Method under test: {@link NamedViewResolver#postExecute(Object, OperationChain, Context)}
   */
  @Test
   ...
   * <p>
   * Method under test: {@link NamedViewResolver#onFailure(Object, OperationChain, Context, Exception)}
   */
  @Test
  @DisplayName("Test onFailure(Object, OperationChain, Context, Exception)")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"Object NamedViewResolver.onFailure(Object, OperationChain, Context, Exception)"})
  void testOnFailure() {
    // Arrange
    NamedViewResolver namedViewResolver = new NamedViewResolver("Suffix Named View Cache Name");
    OperationChain<?> opChain = new OperationChain<>();
