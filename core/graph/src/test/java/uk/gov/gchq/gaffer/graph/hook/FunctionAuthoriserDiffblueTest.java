...
class FunctionAuthoriserDiffblueTest {
  ...
  @MethodsUnderTest({"void FunctionAuthoriser.<init>()", "List FunctionAuthoriser.getUnauthorisedFunctions()",
  ...
  void testGettersAndSetters() {
    ...
    List<Class<? extends Function>> actualUnauthorisedFunctions = actualFunctionAuthoriser.getUnauthorisedFunctions();
   ...
   * <ul>
   *   <li>Then return UnauthorisedFunctions is {@link ArrayList#ArrayList()}.</li>
   * </ul>
   * <p>
   * Method under test: {@link FunctionAuthoriser#FunctionAuthoriser(List)}
   */
  @Test
  @DisplayName("Test new FunctionAuthoriser(List); then return UnauthorisedFunctions is ArrayList()")
  @Tag("MaintainedByDiffblue")
  ...
  void testNewFunctionAuthoriser_thenReturnUnauthorisedFunctionsIsArrayList() {
    ...
    // Act and Assert
    assertSame(unauthorisedFunctions, (new FunctionAuthoriser(unauthorisedFunctions)).getUnauthorisedFunctions());
  }

  /**
   * Test {@link FunctionAuthoriser#FunctionAuthoriser(List)}.
   * <ul>
   *   <li>Then return UnauthorisedFunctions size is one.</li>
   * </ul>
   * <p>
   * Method under test: {@link FunctionAuthoriser#FunctionAuthoriser(List)}
   */
  ...
  void testNewFunctionAuthoriser_thenReturnUnauthorisedFunctionsSizeIsOne() {
    ...
    // Act and Assert
    List<Class<? extends Function>> unauthorisedFunctions2 = (new FunctionAuthoriser(unauthorisedFunctions))
   ...
   *   <li>Then return UnauthorisedFunctions Empty.</li>
   * </ul>
   * <p>
   * Method under test: {@link FunctionAuthoriser#FunctionAuthoriser(List)}
   */
  @Test
  @DisplayName("Test new FunctionAuthoriser(List); when ArrayList(); then return UnauthorisedFunctions Empty")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void FunctionAuthoriser.<init>(List)"})
