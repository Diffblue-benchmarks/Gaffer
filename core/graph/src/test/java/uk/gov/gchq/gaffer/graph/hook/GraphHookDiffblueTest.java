...
class GraphHookDiffblueTest {
   ...
   * <p>
   * Method under test: {@link GraphHook#postExecute(Object, OperationChain, Context)}
   */
  @Test
   ...
   * <p>
   * Method under test: {@link GraphHook#onFailure(Object, OperationChain, Context, Exception)}
   */
  @Test
  ...
  void testOnFailure() {
    ...
    // Act and Assert
    assertEquals("Result", functionAuthoriser.onFailure("Result", opChain, context, new Exception("foo")));
  }
}
