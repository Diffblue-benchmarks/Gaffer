...
class OperationAuthoriserDiffblueTest {
  ...
  @Test
  @DisplayName(
      "Test preExecute(OperationChain, Context); given OperationAuthoriser (default constructor); when 'null'; then does not throw")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void OperationAuthoriser.preExecute(OperationChain, Context)"})
  void testPreExecute_givenOperationAuthoriser_whenNull_thenDoesNotThrow() {
    // Arrange
    OperationAuthoriser operationAuthoriser = new OperationAuthoriser();

    // Act and Assert
    assertDoesNotThrow(() -> operationAuthoriser.preExecute(null, new Context()));
  }
  ...
  @Test
  @DisplayName(
      "Test preExecute(OperationChain, Context); given OperationAuthoriser (default constructor); when OperationChain(); then does not throw")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void OperationAuthoriser.preExecute(OperationChain, Context)"})
  void testPreExecute_givenOperationAuthoriser_whenOperationChain_thenDoesNotThrow() {
    // Arrange
    OperationAuthoriser operationAuthoriser = new OperationAuthoriser();
    OperationChain<Object> opChain = new OperationChain<>();

    // Act and Assert
    assertDoesNotThrow(() -> operationAuthoriser.preExecute(opChain, new Context()));
  }
   ...
   *
   * <ul>
   *   <li>When wrap {@link ExportToOtherAuthorisedGraph} (default constructor).
   *   <li>Then does not throw.
   * </ul>
   *
   * <p>Method under test: {@link OperationAuthoriser#preExecute(OperationChain, Context)}
  ...
  @Test
  @DisplayName(
      "Test preExecute(OperationChain, Context); when wrap ExportToOtherAuthorisedGraph (default constructor); then does not throw")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void OperationAuthoriser.preExecute(OperationChain, Context)"})
  void testPreExecute_whenWrapExportToOtherAuthorisedGraph_thenDoesNotThrow() {
    // Arrange
    OperationAuthoriser operationAuthoriser = new OperationAuthoriser();
    OperationChain<?> opChain = OperationChain.wrap(new ExportToOtherAuthorisedGraph());
  ...
  @Test
  @DisplayName(
      "Test authorise(Operation, User); given OperationAuthoriser (default constructor); then does not throw")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void OperationAuthoriser.authorise(Operation, User)"})
  void testAuthorise_givenOperationAuthoriser_thenDoesNotThrow() {
    // Arrange
    OperationAuthoriser operationAuthoriser = new OperationAuthoriser();
    ExportToOtherAuthorisedGraph operation = new ExportToOtherAuthorisedGraph();

    // Act and Assert
    assertDoesNotThrow(() -> operationAuthoriser.authorise(operation, new User()));
  }
  ...
  @Test
  @DisplayName(
      "Test authorise(Operation, User); given OperationAuthoriser (default constructor); when 'null'; then does not throw")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void OperationAuthoriser.authorise(Operation, User)"})
  void testAuthorise_givenOperationAuthoriser_whenNull_thenDoesNotThrow() {
    // Arrange
    OperationAuthoriser operationAuthoriser = new OperationAuthoriser();

    // Act and Assert
    assertDoesNotThrow(() -> operationAuthoriser.authorise(null, new User()));
  }
