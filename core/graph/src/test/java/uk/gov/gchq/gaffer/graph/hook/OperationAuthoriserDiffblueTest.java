...
class OperationAuthoriserDiffblueTest {
   ...
   * <ul>
   *   <li>Then throw {@link UnauthorisedException}.</li>
   * </ul>
   * <p>
   * Method under test: {@link OperationAuthoriser#preExecute(OperationChain, Context)}
   */
  @Test
  ...
  void testPreExecute_thenThrowUnauthorisedException() {
    ...
    // Act and Assert
    assertThrows(UnauthorisedException.class, () -> operationAuthoriser.preExecute(opChain, new Context()));
  }

  /**
   * Test {@link OperationAuthoriser#postExecute(Object, OperationChain, Context)}.
   * <p>
   * Method under test: {@link OperationAuthoriser#postExecute(Object, OperationChain, Context)}
   */
  @Test
   ...
   * <p>
   * Method under test: {@link OperationAuthoriser#onFailure(Object, OperationChain, Context, Exception)}
   */
  @Test
  @DisplayName("Test onFailure(Object, OperationChain, Context, Exception)")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"Object OperationAuthoriser.onFailure(Object, OperationChain, Context, Exception)"})
  void testOnFailure() {
    // Arrange
    OperationAuthoriser operationAuthoriser = new OperationAuthoriser();
    OperationChain<?> opChain = new OperationChain<>();
    ...
    // Act and Assert
    assertEquals("Result", operationAuthoriser.onFailure("Result", opChain, context, new Exception("foo")));
  }

  /**
   * Test {@link OperationAuthoriser#getAuths()}.
   * <p>
   * Method under test: {@link OperationAuthoriser#getAuths()}
   */
  @Test
   ...
   * <ul>
   *   <li>Given {@link OperationAuthoriser} (default constructor).</li>
   *   <li>Then return Empty.</li>
   * </ul>
   * <p>
   * Method under test: {@link OperationAuthoriser#getAuthsAsStrings()}
   */
  @Test
  @DisplayName("Test getAuthsAsStrings(); given OperationAuthoriser (default constructor); then return Empty")
  @Tag("MaintainedByDiffblue")
   ...
   */
  @Test
  @DisplayName("Test getAuthsAsStrings(); given 'uk.gov.gchq.gaffer.operation.Operation'; then return size is one")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"Map OperationAuthoriser.getAuthsAsStrings()"})
   ...
   * <p>
   * Method under test: {@link OperationAuthoriser#getAllAuths()}
   */
  @Test
   ...
   * </ul>
   * <p>
   * Method under test: {@link OperationAuthoriser#authorise(Operation, User)}
   */
  @Test
  ...
  void testAuthorise_thenThrowUnauthorisedException() {
    ...
    // Act and Assert
    assertThrows(UnauthorisedException.class, () -> operationAuthoriser.authorise(operation, new User()));
  }

  /**
   * Test new {@link OperationAuthoriser} (default constructor).
   * <p>
   * Method under test: default or parameterless constructor of {@link OperationAuthoriser}
   */
  @Test
