...
class GafferResultCacheUtilDiffblueTest {
   ...
   *   <li>Then return array length is six hundred forty-five.</li>
   * </ul>
   * <p>
   * Method under test: {@link GafferResultCacheUtil#createSchema(Long)}
   */
  @Test
  @DisplayName("Test createSchema(Long); when 'null'; then return array length is six hundred forty-five")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"Schema GafferResultCacheUtil.createSchema(Long)"})
  void testCreateSchema_whenNull_thenReturnArrayLengthIsSixHundredFortyFive() throws SchemaException {
    // Arrange and Act
    ...
    assertTrue(types.containsKey(Boolean.TRUE.toString()));
  }
   ...
   * <ul>
   *   <li>When ten.</li>
   *   <li>Then return array length is seven hundred thirty-seven.</li>
   * </ul>
   * <p>
   * Method under test: {@link GafferResultCacheUtil#createSchema(Long)}
   */
  @Test
  @DisplayName("Test createSchema(Long); when ten; then return array length is seven hundred thirty-seven")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"Schema GafferResultCacheUtil.createSchema(Long)"})
  void testCreateSchema_whenTen_thenReturnArrayLengthIsSevenHundredThirtySeven() throws SchemaException {
    // Arrange and Act
