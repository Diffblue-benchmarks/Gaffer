...
class ConsumableBlockingQueueDiffblueTest {
  ...
  @MethodsUnderTest({"void ConsumableBlockingQueue.<init>(int)", "java.lang.String ConsumableBlockingQueue.toString()"})
  void testGettersAndSetters() {
    // Arrange and Act
    ConsumableBlockingQueue<Object> actualConsumableBlockingQueue = new ConsumableBlockingQueue<>(3);
