...
class CachingIterableDiffblueTest {
   ...
   */
  @Test
  @DisplayName("Test new CachingIterable(Iterable); when ArrayList(); then return not iterator hasNext")
   ...
   */
  @Test
  @DisplayName("Test new CachingIterable(Iterable, int); when ArrayList(); then return not iterator hasNext")
  @Tag("MaintainedByDiffblue")
   ...
   */
  @Test
  @DisplayName("Test new CachingIterable(Iterable, int); when 'null'; then return not iterator hasNext")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void CachingIterable.<init>(Iterable, int)"})
