...
class ByteArrayEscapeUtilsDiffblueTest {
  /**
   * Test {@link ByteArrayEscapeUtils#escape(byte[], byte[])} with {@code bytes}, {@code appendAfterEscaping}.
   * <p>
   ...
   */
  @Test
  @DisplayName("Test escape(byte[], byte[]) with 'bytes', 'appendAfterEscaping'; then return 'AXAXAXAXAXAXAXAX' Bytes is 'UTF-8'")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"byte[] ByteArrayEscapeUtils.escape(byte[], byte[])"})
  ...
  /**
   * Test {@link ByteArrayEscapeUtils#unEscape(byte[], int, int)} with {@code allBytes}, {@code start}, {@code end}.
   * <ul>
   *   <li>Then return array of {@code byte} with {@link ByteArrayEscapeUtils#DELIMITER_PLUS_ONE}.</li>
   * </ul>
   * <p>
   * Method under test: {@link ByteArrayEscapeUtils#unEscape(byte[], int, int)}
   */
  @Test
  @DisplayName("Test unEscape(byte[], int, int) with 'allBytes', 'start', 'end'; then return array of byte with DELIMITER_PLUS_ONE")
  @Tag("MaintainedByDiffblue")
   ...
   */
  @Test
  @DisplayName("Test unEscape(byte[], int, int) with 'allBytes', 'start', 'end'; then return array of byte with 'X' and 'A'")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"byte[] ByteArrayEscapeUtils.unEscape(byte[], int, int)"})
  void testUnEscapeWithAllBytesStartEnd_thenReturnArrayOfByteWithXAndA() throws UnsupportedEncodingException {
    // Arrange, Act and Assert
   ...
   */
  @Test
  @DisplayName("Test unEscape(byte[], int, int) with 'allBytes', 'start', 'end'; then throw InvalidParameterException")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"byte[] ByteArrayEscapeUtils.unEscape(byte[], int, int)"})
   ...
   */
  @Test
  @DisplayName("Test unEscape(byte[], int, int) with 'allBytes', 'start', 'end'; when 'A'; then return array of byte with 'A'")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"byte[] ByteArrayEscapeUtils.unEscape(byte[], int, int)"})
   ...
   */
  @Test
  @DisplayName("Test unEscape(byte[], int, int) with 'allBytes', 'start', 'end'; when eight; then return 'XAXAXAX' Bytes is 'UTF-8'")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"byte[] ByteArrayEscapeUtils.unEscape(byte[], int, int)"})
  void testUnEscapeWithAllBytesStartEnd_whenEight_thenReturnXaxaxaxBytesIsUtf8() throws UnsupportedEncodingException {
    // Arrange and Act
   ...
   * <ul>
   *   <li>When {@code X}.</li>
   *   <li>Then return array of {@code byte} with {@link ByteArrayEscapeUtils#DELIMITER}.</li>
   * </ul>
   * <p>
   * Method under test: {@link ByteArrayEscapeUtils#unEscape(byte[], int, int)}
   */
  @Test
  @DisplayName("Test unEscape(byte[], int, int) with 'allBytes', 'start', 'end'; when 'X'; then return array of byte with DELIMITER")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"byte[] ByteArrayEscapeUtils.unEscape(byte[], int, int)"})
   ...
   * <ul>
   *   <li>Then return array of {@code byte} with {@link ByteArrayEscapeUtils#DELIMITER} and {@code A}.</li>
   * </ul>
   * <p>
   * Method under test: {@link ByteArrayEscapeUtils#unEscape(byte[])}
   */
  @Test
  @DisplayName("Test unEscape(byte[]) with 'bytes'; then return array of byte with DELIMITER and 'A'")
  @Tag("MaintainedByDiffblue")
   ...
   * Test {@link ByteArrayEscapeUtils#unEscape(byte[])} with {@code bytes}.
   * <ul>
   *   <li>Then return array of {@code byte} with {@link ByteArrayEscapeUtils#DELIMITER_PLUS_ONE} and {@code A}.</li>
   * </ul>
   * <p>
   * Method under test: {@link ByteArrayEscapeUtils#unEscape(byte[])}
   */
  @Test
  @DisplayName("Test unEscape(byte[]) with 'bytes'; then return array of byte with DELIMITER_PLUS_ONE and 'A'")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"byte[] ByteArrayEscapeUtils.unEscape(byte[])"})
   ...
   */
  @Test
  @DisplayName("Test unEscape(byte[]) with 'bytes'; when 'AXAXAXAX' Bytes is 'UTF-8'; then return 'AXAXAXAX' Bytes is 'UTF-8'")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"byte[] ByteArrayEscapeUtils.unEscape(byte[])"})
   ...
   * </ul>
   * <p>
   * Method under test: {@link ByteArrayEscapeUtils#unEscapeByPosition(byte[], int, int)}
   */
  @Test
  @DisplayName("Test unEscapeByPosition(byte[], int, int); when 'A'; then return array of byte with 'A'")
  @Tag("MaintainedByDiffblue")
   ...
   */
  @Test
  @DisplayName("Test unEscapeByPosition(byte[], int, int); when 'AXAXAXAX' Bytes is 'UTF-8'; then return array of byte with 'X' and 'A'")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"byte[] ByteArrayEscapeUtils.unEscapeByPosition(byte[], int, int)"})
   ...
   */
  @Test
  @DisplayName("Test unEscapeByPosition(byte[], int, int); when eight; then return 'XAXAXAX' Bytes is 'UTF-8'")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"byte[] ByteArrayEscapeUtils.unEscapeByPosition(byte[], int, int)"})
  void testUnEscapeByPosition_whenEight_thenReturnXaxaxaxBytesIsUtf8() throws UnsupportedEncodingException {
    // Arrange and Act
   ...
   */
  @Test
  @DisplayName("Test unEscapeByPosition(byte[], int, int); when empty array of byte; then throw InvalidParameterException")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"byte[] ByteArrayEscapeUtils.unEscapeByPosition(byte[], int, int)"})
   ...
   */
  @Test
  @DisplayName("Test unEscapeByPosition(byte[], int, int); when 'X'; then return array of byte with DELIMITER")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"byte[] ByteArrayEscapeUtils.unEscapeByPosition(byte[], int, int)"})
   ...
   */
  @Test
  @DisplayName("Test unEscapeByPosition(byte[], int, int); when 'X'; then return array of byte with DELIMITER_PLUS_ONE")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"byte[] ByteArrayEscapeUtils.unEscapeByPosition(byte[], int, int)"})
   ...
   * </ul>
   * <p>
   * Method under test: {@link ByteArrayEscapeUtils#unEscapeByLength(byte[], int, int)}
   */
  @Test
  @DisplayName("Test unEscapeByLength(byte[], int, int); when 'A'; then return array of byte with DELIMITER and 'A'")
  @Tag("MaintainedByDiffblue")
   ...
   */
  @Test
  @DisplayName("Test unEscapeByLength(byte[], int, int); when 'A'; then return array of byte with DELIMITER_PLUS_ONE and 'A'")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"byte[] ByteArrayEscapeUtils.unEscapeByLength(byte[], int, int)"})
   ...
   */
  @Test
  @DisplayName("Test unEscapeByLength(byte[], int, int); when 'AXAXAXAX' Bytes is 'UTF-8'; then return 'AXA' Bytes is 'UTF-8'")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"byte[] ByteArrayEscapeUtils.unEscapeByLength(byte[], int, int)"})
  void testUnEscapeByLength_whenAxaxaxaxBytesIsUtf8_thenReturnAxaBytesIsUtf8() throws UnsupportedEncodingException {
    // Arrange and Act
   ...
   */
  @Test
  @DisplayName("Test unEscapeByLength(byte[], int, int); when empty array of byte; then throw InvalidParameterException")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"byte[] ByteArrayEscapeUtils.unEscapeByLength(byte[], int, int)"})
   ...
   */
  @Test
  @DisplayName("Test unEscapeByLength(byte[], int, int); when five; then return 'XAX' Bytes is 'UTF-8'")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"byte[] ByteArrayEscapeUtils.unEscapeByLength(byte[], int, int)"})
  void testUnEscapeByLength_whenFive_thenReturnXaxBytesIsUtf8() throws UnsupportedEncodingException {
    // Arrange and Act
   ...
   */
  @Test
  @DisplayName("Test unEscapeByLength(byte[], int, int); when 'X'; then return array of byte with 'X' and 'A'")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"byte[] ByteArrayEscapeUtils.unEscapeByLength(byte[], int, int)"})
