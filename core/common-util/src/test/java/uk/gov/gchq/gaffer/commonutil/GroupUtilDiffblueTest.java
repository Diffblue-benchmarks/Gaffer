...
class GroupUtilDiffblueTest {
   ...
   */
  @Test
  @DisplayName("Test validateName(String); when 'Group'; then does not throw")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void GroupUtil.validateName(String)"})
  void testValidateName_whenGroup_thenDoesNotThrow() {
    // Arrange, Act and Assert
    assertDoesNotThrow(() -> GroupUtil.validateName("Group"));
  }
}
