...
class GafferCollectorsDiffblueTest {
   ...
   * <p>
   * Method under test: {@link GafferCollectorImpl#characteristics()}
   */
  @Test
  ...
  void testGafferCollectorImplCharacteristics() {
    // Arrange
    GafferCollectorImpl<Object, Object, Object> gafferCollectorImpl = new GafferCollectorImpl<>(mock(Supplier.class),
        mock(BiConsumer.class), mock(BinaryOperator.class));
   ...
   * Methods under test:
   * <ul>
   *   <li>{@link GafferCollectorImpl#GafferCollectorImpl(Supplier, BiConsumer, BinaryOperator, Function)}
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void GafferCollectorImpl.<init>(Supplier, BiConsumer, BinaryOperator, Function)",
      "BiConsumer GafferCollectorImpl.accumulator()", "BinaryOperator GafferCollectorImpl.combiner()",
      "Function GafferCollectorImpl.finisher()", "Supplier GafferCollectorImpl.supplier()"})
  void testGafferCollectorImplGettersAndSetters() {
    ...
    // Act
    GafferCollectorImpl<Object, Object, Object> actualGafferCollectorImpl = new GafferCollectorImpl<>(supplier,
  ...
  /**
   * Test GafferCollectorImpl {@link GafferCollectorImpl#GafferCollectorImpl(Supplier, BiConsumer, BinaryOperator)}.
   * <p>
   * Method under test: {@link GafferCollectorImpl#GafferCollectorImpl(Supplier, BiConsumer, BinaryOperator)}
   */
  @Test
  @DisplayName("Test GafferCollectorImpl new GafferCollectorImpl(Supplier, BiConsumer, BinaryOperator)")
  @Tag("MaintainedByDiffblue")
   ...
   * <p>
   * Method under test: {@link GafferCollectors#toLimitedInMemorySortedIterable(Comparator, Integer, boolean)}
   */
  @Test
  @DisplayName("Test toLimitedInMemorySortedIterable(Comparator, Integer, boolean)")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"Collector GafferCollectors.toLimitedInMemorySortedIterable(Comparator, Integer, boolean)"})
