...
class LimitExceededExceptionDiffblueTest {
   ...
   * <p>
   * Method under test: {@link LimitExceededException#LimitExceededException(String)}
   */
  @Test
  ...
  void testNewLimitExceededException() {
    // Arrange and Act
    LimitExceededException actualLimitExceededException = new LimitExceededException("An error occurred");
