...
class CloseableUtilDiffblueTest {
   ...
   * <ul>
   *   <li>When {@link AutoCloseable} {@link AutoCloseable#close()} does nothing.</li>
   *   <li>Then calls {@link AutoCloseable#close()}.</li>
   * </ul>
   * <p>
   * Method under test: {@link CloseableUtil#close(AutoCloseable)}
   */
  @Test
  @DisplayName("Test close(AutoCloseable) with 'AutoCloseable'; when AutoCloseable close() does nothing; then calls close()")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void CloseableUtil.close(AutoCloseable)"})
  void testCloseWithAutoCloseable_whenAutoCloseableCloseDoesNothing_thenCallsClose() throws Exception {
    // Arrange
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void CloseableUtil.close(AutoCloseable[])"})
  void testCloseWithAutoCloseable_whenAutoCloseableCloseDoesNothing_thenCallsClose2() throws Exception {
    // Arrange
