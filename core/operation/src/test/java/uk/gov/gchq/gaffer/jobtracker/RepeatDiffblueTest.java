...
class RepeatDiffblueTest {
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"long Repeat.getInitialDelay()", "long Repeat.getRepeatPeriod()", "TimeUnit Repeat.getTimeUnit()",
      "void Repeat.setInitialDelay(long)", "void Repeat.setRepeatPeriod(long)", "void Repeat.setTimeUnit(TimeUnit)",
  ...
  void testGettersAndSetters() {
    ...
    // Assert
    assertEquals("Repeat[initialDelay=1,repeatPeriod=1,timeUnit=NANOSECONDS]", actualToStringResult);
