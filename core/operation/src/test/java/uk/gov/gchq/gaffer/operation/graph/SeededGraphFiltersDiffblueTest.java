...
class SeededGraphFiltersDiffblueTest {
   ...
   * <p>
   * Method under test: {@link SeededGraphFilters.Builder#inOutType(IncludeIncomingOutgoingType)}
   */
  @Test
  @DisplayName("Test Builder inOutType(IncludeIncomingOutgoingType)")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"SeededGraphFilters.Builder SeededGraphFilters.Builder.inOutType(IncludeIncomingOutgoingType)"})
  void testBuilderInOutType() {
    // Arrange
    Builder builder = new Builder();

    // Act and Assert
    assertSame(builder, builder.inOutType(IncludeIncomingOutgoingType.EITHER));
  }
}
