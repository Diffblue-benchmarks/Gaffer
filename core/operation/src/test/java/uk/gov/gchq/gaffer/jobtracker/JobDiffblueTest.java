...
class JobDiffblueTest {
  ...
  @MethodsUnderTest({"void Job.<init>()", "void Job.<init>(Repeat)", "void Job.<init>(Repeat, Operation)",
      "Operation Job.getOperation()", "Repeat Job.getRepeat()", "void Job.setOperation(Operation)",
      "void Job.setRepeat(Repeat)", "java.lang.String Job.toString()"})
