...
class JoinFunctionDiffblueTest {
   ...
   * </ul>
   * <p>
   * Method under test: {@link JoinFunction#join(Iterable, Iterable, Match, MatchKey, Boolean)}
   */
  @Test
  @DisplayName("Test join(Iterable, Iterable, Match, MatchKey, Boolean); when 'false'; then return Empty")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"java.util.List JoinFunction.join(Iterable, Iterable, Match, MatchKey, Boolean)"})
   ...
   */
  @Test
  @DisplayName("Test join(Iterable, Iterable, Match, MatchKey, Boolean); when 'LEFT'; then return Empty")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"java.util.List JoinFunction.join(Iterable, Iterable, Match, MatchKey, Boolean)"})
  void testJoin_whenLeft_thenReturnEmpty() {
    // Arrange
    FullJoin fullJoin = new FullJoin();
    ArrayList<Object> left = new ArrayList<>();
    ArrayList<Object> right = new ArrayList<>();
   ...
   */
  @Test
  @DisplayName("Test join(Iterable, Iterable, Match, MatchKey, Boolean); when 'RIGHT'; then return Empty")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"java.util.List JoinFunction.join(Iterable, Iterable, Match, MatchKey, Boolean)"})
