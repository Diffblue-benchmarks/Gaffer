...
class ParameterDetailDiffblueTest {
  ...
  @Test
  @DisplayName(
      "Test new ParameterDetail(String, Class, boolean, Object, List); when 'uk.gov.gchq.gaffer.named.operation.ParameterDetail'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void ParameterDetail.<init>(String, Class, boolean, Object, List)"})
  void testNewParameterDetail_whenUkGovGchqGafferNamedOperationParameterDetail() {
    // Arrange
