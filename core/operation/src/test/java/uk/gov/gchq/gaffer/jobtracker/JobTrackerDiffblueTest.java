...
class JobTrackerDiffblueTest {
   ...
   * <ul>
   *   <li>Given one.
   *   <li>When {@link JobDetail#JobDetail()} StartTime is one.
   * </ul>
   *
   * <p>Method under test: {@link JobTracker#addOrUpdateJob(JobDetail, User)}
   */
  @Test
  @DisplayName("Test addOrUpdateJob(JobDetail, User); given one; when JobDetail() StartTime is one")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void JobTracker.addOrUpdateJob(JobDetail, User)"})
  void testAddOrUpdateJob_givenOne_whenJobDetailStartTimeIsOne() {
    // Arrange
    JobTracker jobTracker = new JobTracker("Suffix Job Tracker Cache Name");
  ...
  void testGetAllJobs() {
    // Arrange
    JobTracker jobTracker = new JobTracker("42java.lang.Iterable");

    Builder parentJobIdResult =
        new Builder()
            .description(
                "The characteristics of someone or somethingDescriptionThe characteristics of someone or something")
            .jobId("42")
            .opChain("Op Chain")
            .parentJobId("42");
    ...
    assertEquals("42java.lang.iterable", jobTracker.getSuffixCacheName());
    assertEquals("JobTracker_42java.lang.iterable", jobTracker.getCacheName());
   ...
   *
   * <ul>
   *   <li>Given {@link JobTracker#JobTracker(String)} with suffixJobTrackerCacheName is {@code
   *       42java.lang.Iterable}.
   * </ul>
   *
   * <p>Method under test: {@link JobTracker#getAllJobs(User)}
   */
  @Test
  @DisplayName(
      "Test getAllJobs(User); given JobTracker(String) with suffixJobTrackerCacheName is '42java.lang.Iterable'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"java.lang.Iterable JobTracker.getAllJobs(User)"})
  void testGetAllJobs_givenJobTrackerWithSuffixJobTrackerCacheNameIs42javaLangIterable() {
    // Arrange
    JobTracker jobTracker = new JobTracker("42java.lang.Iterable");
    User user = new User();
