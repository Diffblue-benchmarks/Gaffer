...
class AggregatePairDiffblueTest {
  ...
  @MethodsUnderTest({"void AggregatePair.<init>()", "void AggregatePair.<init>(ElementAggregator)",
      "void AggregatePair.<init>(String[])", "void AggregatePair.<init>(String[], ElementAggregator)",
      "ElementAggregator AggregatePair.getElementAggregator()", "String[] AggregatePair.getGroupBy()",
      "void AggregatePair.setElementAggregator(ElementAggregator)", "void AggregatePair.setGroupBy(String[])"})
   ...
   * Test getters and setters.
   * <ul>
   *   <li>When array of {@link String} with {@code Group By}.</li>
   * </ul>
   * <p>
   * Methods under test:
   * <ul>
  ...
  void testGettersAndSetters_whenArrayOfStringWithGroupBy() {
    ...
    // Act
    AggregatePair actualAggregatePair = new AggregatePair(new String[]{"Group By"}, aggregator);
    ElementAggregator elementAggregator = (new Builder()).build();
    actualAggregatePair.setElementAggregator(elementAggregator);
    String[] groupBy = new String[]{"Group By"};
    actualAggregatePair.setGroupBy(groupBy);
