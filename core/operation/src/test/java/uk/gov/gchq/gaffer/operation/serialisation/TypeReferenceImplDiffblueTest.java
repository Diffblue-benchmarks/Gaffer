...
class TypeReferenceImplDiffblueTest {
   ...
   *
   * <p>Method under test: default or parameterless constructor of {@link Array}
   */
  @Test
   ...
   *
   * <p>Method under test: {@link TypeReferenceImpl#createExplicitT()}
   */
  @Test
   ...
   *
   * <p>Method under test: {@link TypeReferenceImpl#createIterableT()}
   */
  @Test
   ...
   *
   * <p>Method under test: default or parameterless constructor of {@link IterableEdge}
   */
  @Test
  ...
  void testIterableEdgeNewIterableEdge() {
    ...
    assertEquals(
        "java.lang.Iterable<uk.gov.gchq.gaffer.data.element.Edge>",
   ...
   *
   * <p>Method under test: default or parameterless constructor of {@link IterableElement}
   */
  @Test
   ...
   *
   * <p>Method under test: default or parameterless constructor of {@link IterableEntityId}
   */
  @Test
   ...
   *
   * <p>Method under test: default or parameterless constructor of {@link IterableEntitySeed}
   */
  @Test
   ...
   *
   * <p>Method under test: default or parameterless constructor of {@link IterableIterableEdge}
   */
  @Test
  ...
  void testIterableIterableEdgeNewIterableIterableEdge() {
    // Arrange, Act and Assert
    assertEquals(
        "java.lang.Iterable<java.lang.Iterable<uk.gov.gchq.gaffer.data.element.Edge>>",
   ...
   *
   * <p>Method under test: default or parameterless constructor of {@link IterableListEdge}
   */
  @Test
  ...
  void testIterableListEdgeNewIterableListEdge() {
    // Arrange, Act and Assert
    assertEquals(
        "java.lang.Iterable<java.util.List<uk.gov.gchq.gaffer.data.element.Edge>>",
   ...
   *
   * <p>Method under test: default or parameterless constructor of {@link IterableMap}
   */
  @Test
  ...
  void testIterableMapNewIterableMap() {
    // Arrange, Act and Assert
    assertEquals(
        "java.lang.Iterable<? extends java.util.Map<java.lang.String, java.lang.Object>>",
   ...
   *
   * <p>Method under test: default or parameterless constructor of {@link IterableObj}
   */
  @Test
   ...
   *
   * <p>Method under test: default or parameterless constructor of {@link IterableObject}
   */
  @Test
   ...
   *
   * <p>Method under test: default or parameterless constructor of {@link IterableString}
   */
  @Test
  ...
  void testIterableStringNewIterableString() {
    ...
    assertEquals(
        ...
        new IterableString().getType().getTypeName());
  }

  /**
   * Test IterableWalk new {@link IterableWalk} (default constructor).
   *
   * <p>Method under test: default or parameterless constructor of {@link IterableWalk}
   */
  @Test
   ...
   *
   * <p>Method under test: default or parameterless constructor of {@link JobDetailIterable}
   */
  @Test
   ...
   *
   * <p>Method under test: default or parameterless constructor of {@link List}
   */
  @Test
   ...
   *
   * <p>Method under test: default or parameterless constructor of {@link ListString}
   */
  @Test
   ...
   *
   * <p>Method under test: default or parameterless constructor of {@link MapExporter}
   */
  @Test
  ...
  void testMapExporterNewMapExporter() {
    // Arrange, Act and Assert
    assertEquals(
        "java.util.LinkedHashMap<java.lang.String, uk.gov.gchq.gaffer.operation.export.Exporter>",
   ...
   *
   * <p>Method under test: default or parameterless constructor of {@link MapStringObject}
   */
  @Test
  ...
  void testMapStringObjectNewMapStringObject() {
    ...
    assertEquals(
        ...
        new MapStringObject().getType().getTypeName());
  }

  /**
   * Test MapStringSet new {@link MapStringSet} (default constructor).
   *
   * <p>Method under test: default or parameterless constructor of {@link MapStringSet}
   */
  @Test
   ...
   *
   * <p>Method under test: default or parameterless constructor of {@link MapStringString}
   */
  @Test
  ...
  void testMapStringStringNewMapStringString() {
    ...
    assertEquals(
        ...
        new MapStringString().getType().getTypeName());
  }
  ...
  void testOperationsNewOperations() {
    // Arrange, Act and Assert
    assertEquals(
        "uk.gov.gchq.gaffer.operation.serialisation.TypeReferenceImpl$Set<java.lang.Class<uk.gov.gchq.gaffer"
            + ".operation.Operation>>",
   ...
   *
   * <p>Method under test: default or parameterless constructor of {@link Set}
   */
  @Test
   ...
   *
   * <p>Method under test: default or parameterless constructor of {@link Stream}
   */
  @Test
