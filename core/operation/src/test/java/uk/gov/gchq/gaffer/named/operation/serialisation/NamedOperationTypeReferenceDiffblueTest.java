...
class NamedOperationTypeReferenceDiffblueTest {
  /**
   * Test IterableNamedOperationDetail new {@link IterableNamedOperationDetail} (default constructor).
   * <p>
   * Method under test: default or parameterless constructor of {@link IterableNamedOperationDetail}
   */
  @Test
  @DisplayName("Test IterableNamedOperationDetail new IterableNamedOperationDetail (default constructor)")
