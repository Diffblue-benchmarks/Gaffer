...
class FilterStreamSupplierDiffblueTest {
   ...
   * <ul>
   *   <li>Given {@link Filter} (default constructor) Input is {@link ArrayList#ArrayList()}.</li>
   *   <li>Then return limit five collect toList Empty.</li>
   * </ul>
   * <p>
   * Method under test: {@link FilterStreamSupplier#get()}
   */
  @Test
  @DisplayName("Test get(); given Filter (default constructor) Input is ArrayList(); then return limit five collect toList Empty")
