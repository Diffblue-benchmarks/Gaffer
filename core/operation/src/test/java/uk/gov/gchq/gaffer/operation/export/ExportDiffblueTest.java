...
class ExportDiffblueTest {
   ...
   * <ul>
   *   <li>Given {@link ExportToLocalFile} (default constructor) FilePath is {@code foo}.</li>
   ...
   */
  @Test
  @DisplayName("Test getKeyOrDefault(); given ExportToLocalFile (default constructor) FilePath is 'foo'; then return 'foo'")
  @Tag("MaintainedByDiffblue")
   ...
   * Test {@link Export#getKeyOrDefault()}.
   * <ul>
   *   <li>Given {@link ExportToLocalFile} (default constructor).</li>
   *   <li>Then return {@link Export#DEFAULT_KEY}.</li>
   * </ul>
   * <p>
   * Method under test: {@link Export#getKeyOrDefault()}
   */
  @Test
  @DisplayName("Test getKeyOrDefault(); given ExportToLocalFile (default constructor); then return DEFAULT_KEY")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"String Export.getKeyOrDefault()"})
