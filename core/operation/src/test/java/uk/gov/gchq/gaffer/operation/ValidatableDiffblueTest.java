...
class ValidatableDiffblueTest {
  /**
   * Test Builder {@link uk.gov.gchq.gaffer.operation.Validatable.Builder#skipInvalidElements(boolean)}.
   * <p>
   * Method under test: {@link uk.gov.gchq.gaffer.operation.Validatable.Builder#skipInvalidElements(boolean)}
   */
  @Test
  ...
  void testBuilderSkipInvalidElements() {
    ...
    // Act and Assert
    assertSame(builder, builder.skipInvalidElements(true));
  }

  /**
   * Test Builder {@link uk.gov.gchq.gaffer.operation.Validatable.Builder#validate(boolean)}.
   * <p>
   * Method under test: {@link uk.gov.gchq.gaffer.operation.Validatable.Builder#validate(boolean)}
   */
  @Test
