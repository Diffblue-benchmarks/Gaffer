...
class PropertiesTransformerDiffblueTest {
   ...
   *
   * <ul>
   *   <li>Given {@link PropertiesTransformer} (default constructor).
   *   <li>Then return {@link Properties#Properties()}.
   * </ul>
   *
   * <p>Method under test: {@link PropertiesTransformer#apply(Properties)}
   */
  @Test
  @DisplayName(
      "Test apply(Properties) with 'properties'; given PropertiesTransformer (default constructor); then return Properties()")
   ...
   *
   * <p>Method under test: {@link Builder#execute(Function)}
   */
  @Test
  ...
  /**
   * Test {@link PropertiesTransformer#equals(Object)}, and {@link
   * PropertiesTransformer#hashCode()}.
   *
   * <ul>
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "boolean PropertiesTransformer.equals(Object)",
    "int PropertiesTransformer.hashCode()"
  })
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    // Arrange
    PropertiesTransformer propertiesTransformer = new Builder().build();
    PropertiesTransformer propertiesTransformer2 = new Builder().build();

    // Act and Assert
    assertEquals(propertiesTransformer, propertiesTransformer2);
    assertEquals(propertiesTransformer.hashCode(), propertiesTransformer2.hashCode());
  }
   ...
   * </ul>
   *
   * <p>Method under test: {@link PropertiesTransformer#equals(Object)}
   */
  @Test
  ...
  void testEquals_whenOtherIsWrongType_thenReturnNotEqual() {
    // Arrange, Act and Assert
    assertNotEquals(new Builder().build(), "Different type to PropertiesTransformer");
  }

  /**
   * Test new {@link PropertiesTransformer} (default constructor).
   *
   * <p>Method under test: default or parameterless constructor of {@link PropertiesTransformer}
   */
  @Test
   ...
   *
   * <p>Method under test: {@link PropertiesTransformer#toString()}
   */
  @Test
  ...
  void testToString() {
    // Arrange, Act and Assert
    assertEquals(
        "PropertiesTransformer[propertiesTuple=PropertiesTuple[]]",
        new Builder().build().toString());
  }
}
