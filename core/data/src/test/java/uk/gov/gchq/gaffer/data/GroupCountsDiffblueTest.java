...
class GroupCountsDiffblueTest {
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void GroupCounts.<init>()",
    "Map GroupCounts.getEdgeGroups()",
    "Map GroupCounts.getEntityGroups()",
    "boolean GroupCounts.isLimitHit()",
    "void GroupCounts.setEdgeGroups(Map)",
    "void GroupCounts.setEntityGroups(Map)",
    "void GroupCounts.setLimitHit(boolean)",
