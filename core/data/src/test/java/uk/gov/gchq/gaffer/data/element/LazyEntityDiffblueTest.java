...
class LazyEntityDiffblueTest {
   ...
   * </ul>
   * <p>
   * Method under test: {@link LazyEntity#LazyEntity(Entity, ElementValueLoader)}
   */
  @Test
  @DisplayName("Test new LazyEntity(Entity, ElementValueLoader); then return 'Group'")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void LazyEntity.<init>(Entity, ElementValueLoader)"})
   ...
   * </ul>
   * <p>
   * Method under test: {@link LazyEntity#LazyEntity(Entity, ElementValueLoader, LazyProperties)}
   */
  @Test
  @DisplayName("Test new LazyEntity(Entity, ElementValueLoader, LazyProperties); then return 'Group'")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void LazyEntity.<init>(Entity, ElementValueLoader, LazyProperties)"})
  void testNewLazyEntity_thenReturnGroup2() {
    ...
    // Act
    LazyEntity actualLazyEntity = new LazyEntity(entity2, mock(ElementValueLoader.class), mock(LazyProperties.class));
   ...
   * <p>
   * Method under test: {@link LazyEntity#getProperty(String)}
   */
  @Test
  @DisplayName("Test getProperty(String)")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"Object LazyEntity.getProperty(String)"})
  ...
  void testGetProperty2() {
    ...
    lazyEntity.putProperty("42", "Value");
    ...
    assertTrue(properties2.containsKey("42"));
  }
  ...
  void testGetProperty_givenLazyPropertiesGetReturnGet_thenReturnGet() {
    ...
    Entity entity = (new Builder()).group("Group").vertex("Vertex").build();
    LazyEntity lazyEntity = new LazyEntity(entity, mock(ElementValueLoader.class), lazyProperties);
   ...
   * <ul>
   *   <li>Given {@link ElementValueLoader} {@link ElementValueLoader#loadIdentifiers(Element)} does nothing.</li>
   ...
   */
  @Test
  @DisplayName("Test getVertex(); given ElementValueLoader loadIdentifiers(Element) does nothing; then return 'Vertex'")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"Object LazyEntity.getVertex()"})
  void testGetVertex_givenElementValueLoaderLoadIdentifiersDoesNothing_thenReturnVertex() {
    ...
    // Act
    Object actualVertex = (new LazyEntity(entity, valueLoader)).getVertex();
   ...
   * <p>
   * Method under test: {@link LazyEntity#putProperty(String, Object)}
   */
  @Test
  @DisplayName("Test putProperty(String, Object)")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void LazyEntity.putProperty(String, Object)"})
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"String LazyEntity.getGroup()"})
  void testGetGroup() {
    // Arrange
    Entity entity = (new Builder()).group("Group").vertex("Vertex").build();

    // Act and Assert
    assertEquals("Group", (new LazyEntity(entity, mock(ElementValueLoader.class))).getGroup());
  }
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"Entity LazyEntity.getElement()"})
  void testGetElement() {
    // Arrange
    Entity entity = (new Builder()).group("Group").vertex("Vertex").build();

    // Act
    Entity actualElement = (new LazyEntity(entity, mock(ElementValueLoader.class))).getElement();
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"LazyProperties LazyEntity.getProperties()"})
  void testGetProperties() {
    // Arrange
    Entity entity = (new Builder()).group("Group").vertex("Vertex").build();

    // Act and Assert
    assertTrue((new LazyEntity(entity, mock(ElementValueLoader.class))).getProperties().isEmpty());
  }
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"boolean LazyEntity.equals(Object)", "int LazyEntity.hashCode()"})
  ...
  void testEquals_whenOtherIsDifferent_thenReturnNotEqual3() {
    ...
    Entity entity = (new Builder()).group("Group").vertex("Vertex").build();
    Entity entity2 = groupResult.vertex(new LazyEntity(entity, mock(ElementValueLoader.class))).build();
    LazyEntity lazyEntity = new LazyEntity(entity2, mock(ElementValueLoader.class));
    Entity buildResult = (new Builder()).group("Group").vertex("Vertex").build();

    // Act and Assert
    assertNotEquals(lazyEntity, buildResult);
  }
  ...
  void testEquals_whenOtherIsEqual_thenReturnEqual() {
    ...
    // Act and Assert
    assertEquals(lazyEntity, buildResult);
  }
  ...
  void testEquals_whenOtherIsSame_thenReturnNotEqual() {
    ...
    // Act and Assert
    assertNotEquals(new LazyEntity(entity, mock(ElementValueLoader.class)),
  ...
  void testEquals_whenOtherIsWrongType_thenReturnNotEqual() {
    ...
    // Act and Assert
    assertNotEquals(new LazyEntity(entity, mock(ElementValueLoader.class)), "Different type to LazyEntity");
  }

  /**
   * Test {@link LazyEntity#putIdentifier(IdentifierType, Object)}.
   * <p>
   * Method under test: {@link LazyEntity#putIdentifier(IdentifierType, Object)}
   */
  @Test
  @DisplayName("Test putIdentifier(IdentifierType, Object)")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void LazyEntity.putIdentifier(IdentifierType, Object)"})
