...
class ExtractWalkEntitiesFromHopDiffblueTest {
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void ExtractWalkEntitiesFromHop.<init>()",
    "void ExtractWalkEntitiesFromHop.<init>(int)",
    "int ExtractWalkEntitiesFromHop.getHop()",
    "void ExtractWalkEntitiesFromHop.setHop(int)"
  })
