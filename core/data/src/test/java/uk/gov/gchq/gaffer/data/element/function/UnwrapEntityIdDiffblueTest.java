...
class UnwrapEntityIdDiffblueTest {
   ...
   */
  @Test
  @DisplayName("Test apply(Object); when Builder (default constructor) group 'Group' vertex 'Vertex' build; then return 'Vertex'")
  ...
  void testApply_whenBuilderGroupGroupVertexVertexBuild_thenReturnVertex() {
    ...
    // Act and Assert
    assertEquals("Vertex", unwrapEntityId.apply(buildResult));
  }

  /**
   * Test {@link UnwrapEntityId#apply(Object)}.
   * <ul>
   *   <li>When {@code Item}.</li>
