...
class LazyPropertiesDiffblueTest {
   ...
   * <p>
   * Method under test: {@link LazyProperties#LazyProperties(Properties, ElementValueLoader)}
   */
  @Test
  ...
  void testNewLazyProperties() {
    ...
    assertTrue((new LazyProperties(new Properties(), mock(ElementValueLoader.class))).isEmpty());
  }

  /**
   * Test {@link LazyProperties#getProperties()}.
   * <p>
   * Method under test: {@link LazyProperties#getProperties()}
   */
  @Test
  ...
  void testGetProperties() {
    ...
    // Act and Assert
    assertSame(properties, (new LazyProperties(properties, mock(ElementValueLoader.class))).getProperties());
  }
}
