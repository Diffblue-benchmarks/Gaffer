...
class ElementComparatorDiffblueTest {
   ...
   * <p>
   * Method under test: {@link ElementComparator#getComparableGroupPropertyPairs()}
   */
  @Test
  @DisplayName("Test getComparableGroupPropertyPairs()")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"java.util.Set ElementComparator.getComparableGroupPropertyPairs()"})
  void testGetComparableGroupPropertyPairs() {
