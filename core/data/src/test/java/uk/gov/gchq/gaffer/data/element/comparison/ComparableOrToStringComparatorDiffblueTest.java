...
class ComparableOrToStringComparatorDiffblueTest {
   ...
   */
  @Test
  @DisplayName("Test compare(Object, Object); when forName 'UTF-8'; then return minus one")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"int ComparableOrToStringComparator.compare(Object, Object)"})
  void testCompare_whenForNameUtf8_thenReturnMinusOne() {
    // Arrange
    ComparableOrToStringComparator comparableOrToStringComparator =
        new ComparableOrToStringComparator();

    // Act and Assert
    assertEquals(-1, comparableOrToStringComparator.compare(Charset.forName("UTF-8"), null));
  }
