...
class GroupedPropertiesDiffblueTest {
  ...
  @MethodsUnderTest({"void GroupedProperties.<init>()", "void GroupedProperties.<init>(String)",
      "String GroupedProperties.getGroup()", "void GroupedProperties.setGroup(String)"})
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"boolean GroupedProperties.equals(Object)", "int GroupedProperties.hashCode()"})
