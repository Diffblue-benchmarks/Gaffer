...
class KeyFunctionMatchDiffblueTest {
   ...
   */
  @Test
  @DisplayName("Test init(Iterable); given '42'; when ArrayList() add '42'; then does not throw")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void KeyFunctionMatch.init(Iterable)"})
  void testInit_given42_whenArrayListAdd42_thenDoesNotThrow() {
    // Arrange
    ...
    // Act and Assert
    assertDoesNotThrow(() -> keyFunctionMatch.init(matchCandidates));
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void KeyFunctionMatch.init(Iterable)"})
  void testInit_given42_whenArrayListAdd42_thenDoesNotThrow2() {
    // Arrange
    KeyFunctionMatch keyFunctionMatch = new KeyFunctionMatch();
  ...
  @Test
  @DisplayName(
      "Test init(Iterable); given KeyFunctionMatch(); when ArrayList(); then does not throw")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void KeyFunctionMatch.init(Iterable)"})
  void testInit_givenKeyFunctionMatch_whenArrayList_thenDoesNotThrow() {
    // Arrange
    KeyFunctionMatch keyFunctionMatch = new KeyFunctionMatch();

    // Act and Assert
    assertDoesNotThrow(() -> keyFunctionMatch.init(new ArrayList<>()));
  }
