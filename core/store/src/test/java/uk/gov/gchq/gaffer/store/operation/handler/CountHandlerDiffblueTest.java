...
class CountHandlerDiffblueTest {
  /**
   * Test {@link CountHandler#doOperation(Count, Context, Store)} with {@code Count}, {@code Context}, {@code Store}.
   * <ul>
   ...
   */
  @Test
  @DisplayName("Test doOperation(Count, Context, Store) with 'Count', 'Context', 'Store'; when Count (default constructor); then throw OperationException")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"java.lang.Long CountHandler.doOperation(Count, Context, Store)"})
  void testDoOperationWithCountContextStore_whenCount_thenThrowOperationException() throws OperationException {
    // Arrange
