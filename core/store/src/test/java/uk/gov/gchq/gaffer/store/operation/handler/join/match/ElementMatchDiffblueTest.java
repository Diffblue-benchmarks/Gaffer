...
class ElementMatchDiffblueTest {
   ...
   *   <li>Then {@link ElementMatch#ElementMatch()} matching {@code Test Object} is {@link ArrayList#ArrayList()}.</li>
   * </ul>
   * <p>
   * Method under test: {@link ElementMatch#init(Iterable)}
   */
  @Test
  @DisplayName("Test init(Iterable); when ArrayList(); then ElementMatch() matching 'Test Object' is ArrayList()")
   ...
   * <ul>
   *   <li>Given {@link ElementMatch#ElementMatch()} init {@link ArrayList#ArrayList()}.</li>
   *   <li>Then return Empty.</li>
   * </ul>
   * <p>
   * Method under test: {@link ElementMatch#matching(Object)}
   */
  @Test
   ...
   * Test {@link ElementMatch#matching(Object)}.
   * <ul>
   *   <li>Given {@link ElementMatch#ElementMatch()}.</li>
   *   <li>Then throw {@link IllegalArgumentException}.</li>
   * </ul>
   * <p>
   * Method under test: {@link ElementMatch#matching(Object)}
