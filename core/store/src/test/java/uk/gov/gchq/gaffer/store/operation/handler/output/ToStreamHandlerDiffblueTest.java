...
class ToStreamHandlerDiffblueTest {
  /**
   * Method under test:
   * {@link ToStreamHandler#doOperation(ToStream, Context, Store)}
   */
  @Test
  void testDoOperation() throws OperationException {
    ...
    // Act
    Stream<?> actualDoOperationResult = toStreamHandler.doOperation(operation, new Context(), null);
  ...
  void testDoOperation2() throws OperationException {
    ...
    // Act
    Stream<?> actualDoOperationResult = toStreamHandler.doOperation(operation, context, null);
