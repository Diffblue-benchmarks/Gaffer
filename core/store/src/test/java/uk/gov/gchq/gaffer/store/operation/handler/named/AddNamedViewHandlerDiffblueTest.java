...
class AddNamedViewHandlerDiffblueTest {
   ...
   * <p>
   * Method under test: {@link AddNamedViewHandler#AddNamedViewHandler(NamedViewCache)}
   */
  @Test
  ...
  void testNewAddNamedViewHandler() {
    ...
    assertEquals("suffix named view cache name",
        (new AddNamedViewHandler(new NamedViewCache("Suffix Named View Cache Name"))).getSuffixCacheName());
  }

  /**
   * Test {@link AddNamedViewHandler#AddNamedViewHandler(String)}.
   * <p>
   * Method under test: {@link AddNamedViewHandler#AddNamedViewHandler(String)}
   */
  @Test
   ...
   * </ul>
   * <p>
   * Method under test: {@link AddNamedViewHandler#getSuffixCacheName()}
   */
  @Test
  ...
  /**
   * Test {@link AddNamedViewHandler#doOperation(AddNamedView, Context, Store)} with {@code AddNamedView}, {@code Context}, {@code Store}.
   * <ul>
   *   <li>Given empty string.</li>
   * </ul>
   * <p>
   * Method under test: {@link AddNamedViewHandler#doOperation(AddNamedView, Context, Store)}
   */
  @Test
  @DisplayName("Test doOperation(AddNamedView, Context, Store) with 'AddNamedView', 'Context', 'Store'; given empty string")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"java.lang.Object AddNamedViewHandler.doOperation(AddNamedView, Context, Store)"})
  void testDoOperationWithAddNamedViewContextStore_givenEmptyString() throws OperationException {
    // Arrange
    AddNamedViewHandler addNamedViewHandler = new AddNamedViewHandler("Suffix Named View Cache Name");
   ...
   * Test {@link AddNamedViewHandler#doOperation(AddNamedView, Context, Store)} with {@code AddNamedView}, {@code Context}, {@code Store}.
   * <ul>
   *   <li>When {@link AddNamedView} (default constructor).</li>
   * </ul>
   * <p>
   * Method under test: {@link AddNamedViewHandler#doOperation(AddNamedView, Context, Store)}
   */
  @Test
  @DisplayName("Test doOperation(AddNamedView, Context, Store) with 'AddNamedView', 'Context', 'Store'; when AddNamedView (default constructor)")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"java.lang.Object AddNamedViewHandler.doOperation(AddNamedView, Context, Store)"})
