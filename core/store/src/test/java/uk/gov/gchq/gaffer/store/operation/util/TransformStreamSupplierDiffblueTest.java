...
class TransformStreamSupplierDiffblueTest {
   ...
   * <ul>
   *   <li>Given {@link Transform} (default constructor) Input is {@link ArrayList#ArrayList()}.</li>
   *   <li>Then return limit five collect toList Empty.</li>
   * </ul>
   * <p>
   * Method under test: {@link TransformStreamSupplier#get()}
   */
  @Test
  @DisplayName("Test get(); given Transform (default constructor) Input is ArrayList(); then return limit five collect toList Empty")
