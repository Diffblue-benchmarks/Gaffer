...
class OperationDeclarationsDiffblueTest {
   ...
   * <p>
   * Method under test: {@link Builder#declaration(OperationDeclaration)}
   */
  @Test
  ...
  void testBuilderDeclaration() {
    ...
    // Act and Assert
    assertSame(builder, builder.declaration(declaration));
  }
   ...
   * </ul>
   * <p>
   * Method under test: {@link OperationDeclarations#fromPaths(String)}
   */
  @Test
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void OperationDeclarations.<init>()", "List OperationDeclarations.getOperations()",
