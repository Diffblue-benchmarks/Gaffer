...
class ExportOperationHandlerDiffblueTest {
  /**
   * Test {@link ExportOperationHandler#doOperation(Export, Context, Store)} with {@code ExportToLocalFile}, {@code Context}, {@code Store}.
   * <ul>
   *   <li>Then return {@code null}.</li>
   * </ul>
   * <p>
   * Method under test: {@link ExportOperationHandler#doOperation(Export, Context, Store)}
   */
  @Test
  @DisplayName("Test doOperation(Export, Context, Store) with 'ExportToLocalFile', 'Context', 'Store'; then return 'null'")
  ...
  void testDoOperationWithExportToLocalFileContextStore_thenReturnNull() throws OperationException {
    ...
    // Act
    Object actualDoOperationResult = exportToLocalFileHandler.doOperation(exportToLocalFile, context,
