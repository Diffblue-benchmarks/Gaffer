...
class TypeReferenceStoreImplDiffblueTest {
   ...
   * <p>
   * Method under test: default or parameterless constructor of {@link StoreTraits}
   */
  @Test
  ...
  void testStoreTraitsNewStoreTraits() {
    // Arrange, Act and Assert
    assertEquals("java.util.Set<uk.gov.gchq.gaffer.store.StoreTrait>", (new StoreTraits()).getType().getTypeName());
  }
}
