...
class ImportFromLocalFileHandlerDiffblueTest {
  ...
  @MethodsUnderTest({"void ImportFromLocalFileHandler.<init>()", "Class ImportFromLocalFileHandler.getExporterClass()"})
  void testGettersAndSetters() {
    // Arrange and Act
    Class<LocalFileExporter> actualExporterClass = (new ImportFromLocalFileHandler()).getExporterClass();
