...
class ReduceHandlerDiffblueTest {
  ...
  void testDoOperation() throws OperationException {
    ...
    // Act and Assert
    assertThrows(OperationException.class, () -> reduceHandler.doOperation(operation, new Context(), null));
  }
  ...
  void testDoOperation2() throws OperationException {
    ...
    // Act and Assert
    assertThrows(OperationException.class, () -> reduceHandler.doOperation(null, new Context(), null));
  }
}
