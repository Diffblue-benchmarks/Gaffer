...
class IfScoreResolverDiffblueTest {
   ...
   * <p>
   * Method under test: {@link IfScoreResolver#getScore(If)}
   */
  @Test
  ...
  /**
   * Test {@link IfScoreResolver#getScore(If, ScoreResolver)} with {@code operation}, {@code defaultScoreResolver}.
   * <ul>
   *   <li>Given {@link Conditional#Conditional()}.</li>
   * </ul>
   * <p>
   * Method under test: {@link IfScoreResolver#getScore(If, ScoreResolver)}
   */
  @Test
  @DisplayName("Test getScore(If, ScoreResolver) with 'operation', 'defaultScoreResolver'; given Conditional()")
  @Tag("MaintainedByDiffblue")
   ...
   */
  @Test
  @DisplayName("Test getScore(If, ScoreResolver) with 'operation', 'defaultScoreResolver'; when If (default constructor); then return intValue is two")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"java.lang.Integer IfScoreResolver.getScore(If, ScoreResolver)"})
   ...
   */
  @Test
  @DisplayName("Test getScore(If, ScoreResolver) with 'operation', 'defaultScoreResolver'; when 'null'; then return intValue is one")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"java.lang.Integer IfScoreResolver.getScore(If, ScoreResolver)"})
