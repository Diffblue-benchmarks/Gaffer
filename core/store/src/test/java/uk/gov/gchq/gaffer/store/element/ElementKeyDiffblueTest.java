...
class ElementKeyDiffblueTest {
  /**
   * Test {@link ElementKey#create(Element, SchemaElementDefinition)} with {@code element}, {@code elementDef}.
   * <ul>
   *   <li>Then return {@link EntityKey}.</li>
   * </ul>
   * <p>
   * Method under test: {@link ElementKey#create(Element, SchemaElementDefinition)}
   */
  @Test
  @DisplayName("Test create(Element, SchemaElementDefinition) with 'element', 'elementDef'; then return EntityKey")
   ...
   *   <li>Then return {@link EdgeKey}.</li>
   * </ul>
   * <p>
   * Method under test: {@link ElementKey#create(Element, SchemaElementDefinition)}
   */
  @Test
  @DisplayName("Test create(Element, SchemaElementDefinition) with 'element', 'elementDef'; when Edge(String) with 'Group'; then return EdgeKey")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"ElementKey ElementKey.create(Element, SchemaElementDefinition)"})
  ...
  void testCreateWithElementElementDef_whenEdgeWithGroup_thenReturnEdgeKey2() {
    ...
    assertTrue(ElementKey.create(new Edge("Group"), (SchemaElementDefinition) null) instanceof EdgeKey);
  }
   ...
   */
  @Test
  @DisplayName("Test create(Element, SchemaElementDefinition) with 'element', 'elementDef'; when 'null'; then throw IllegalArgumentException")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"ElementKey ElementKey.create(Element, SchemaElementDefinition)"})
  void testCreateWithElementElementDef_whenNull_thenThrowIllegalArgumentException() {
    // Arrange, Act and Assert
    assertThrows(IllegalArgumentException.class, () -> ElementKey.create(null, (SchemaElementDefinition) null));
  }

  /**
   * Test {@link ElementKey#create(Element, Set)} with {@code element}, {@code groupBy}.
   * <p>
   * Method under test: {@link ElementKey#create(Element, Set)}
   */
  @Test
  ...
  void testCreateWithElementGroupBy2() {
    // Arrange
    ElementValueLoader valueLoader = mock(ElementValueLoader.class);
    when(valueLoader.getProperty(Mockito.<String>any(), Mockito.<Properties>any())).thenReturn(null);
    Edge edge = (new Edge.Builder()).dest("Dest")
        .directed(true)
        .group("Group")
        .matchedVertex(MatchedVertex.SOURCE)
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"ElementKey ElementKey.create(Element, Set)"})
  void testCreateWithElementGroupBy3() {
    // Arrange
    ElementValueLoader valueLoader = mock(ElementValueLoader.class);
    when(valueLoader.getProperty(Mockito.<String>any(), Mockito.<Properties>any())).thenReturn("Property");
    Edge edge = (new Edge.Builder()).dest("Dest")
   ...
   */
  @Test
  @DisplayName("Test create(Element, Set) with 'element', 'groupBy'; given empty string; when HashSet() add empty string")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"ElementKey ElementKey.create(Element, Set)"})
   ...
   */
  @Test
  @DisplayName("Test create(Element, Set) with 'element', 'groupBy'; given 'Group By'; when Edge(String) with 'Group'; then return EdgeKey")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"ElementKey ElementKey.create(Element, Set)"})
   ...
   */
  @Test
  @DisplayName("Test create(Element, Set) with 'element', 'groupBy'; when HashSet(); then return EdgeKey")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"ElementKey ElementKey.create(Element, Set)"})
   ...
   */
  @Test
  @DisplayName("Test create(Element, Set) with 'element', 'groupBy'; when 'null'; then return EdgeKey")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"ElementKey ElementKey.create(Element, Set)"})
   ...
   */
  @Test
  @DisplayName("Test create(Element, Set) with 'element', 'groupBy'; when 'null'; then throw IllegalArgumentException")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"ElementKey ElementKey.create(Element, Set)"})
   ...
   * </ul>
   * <p>
   * Method under test: {@link ElementKey#create(Element, Schema)}
   */
  @Test
   ...
   */
  @Test
  @DisplayName("Test create(Element, Schema) with 'element', 'schema'; when Edge(String) with 'Group'; then return EdgeKey")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"ElementKey ElementKey.create(Element, Schema)"})
   ...
   */
  @Test
  @DisplayName("Test create(Element, Schema) with 'element', 'schema'; when 'null'; then throw IllegalArgumentException")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"ElementKey ElementKey.create(Element, Schema)"})
