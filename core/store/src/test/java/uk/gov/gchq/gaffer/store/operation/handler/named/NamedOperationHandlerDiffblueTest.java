...
class NamedOperationHandlerDiffblueTest {
  /**
   * Test {@link NamedOperationHandler#doOperation(NamedOperation, Context, Store)} with {@code NamedOperation}, {@code Context}, {@code Store}.
   * <p>
   * Method under test: {@link NamedOperationHandler#doOperation(NamedOperation, Context, Store)}
   */
  @Test
  @DisplayName("Test doOperation(NamedOperation, Context, Store) with 'NamedOperation', 'Context', 'Store'")
