...
class DescriptionTransformDiffblueTest {
  /**
   * Test {@link DescriptionTransform#apply(String, String, Long)} with {@code junctionA}, {@code junctionB}, {@code count}.
   * <p>
   * Method under test: {@link DescriptionTransform#apply(String, String, Long)}
   */
  @Test
  ...
  void testApplyWithJunctionAJunctionBCount() {
    ...
    assertEquals("3 vehicles have travelled between junction Junction A and junction Junction B",
