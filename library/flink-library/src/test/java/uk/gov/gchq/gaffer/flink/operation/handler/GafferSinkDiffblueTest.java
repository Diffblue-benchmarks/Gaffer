...
class GafferSinkDiffblueTest {
   ...
   * </ul>
   * <p>
   * Method under test: {@link GafferSink#invoke(Element)}
   */
  @Test
  @DisplayName("Test invoke(Element) with 'element'; given GafferAdder add(Element) does nothing; then calls add(Element)")
