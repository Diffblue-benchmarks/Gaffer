...
class GafferMapFunctionDiffblueTest {
   ...
   * </ul>
   * <p>
   * Method under test: {@link GafferMapFunction#GafferMapFunction(Class, Class)}
   */
  @Test
  ...
  void testNewGafferMapFunction_thenThrowIllegalArgumentException() {
    ...
    // Act and Assert
    assertThrows(IllegalArgumentException.class, () -> new GafferMapFunction<>(consumeAs,
   ...
   * </ul>
   * <p>
   * Method under test: {@link GafferMapFunction#setConsumeAs(Class)}
   */
  @Test
  @DisplayName("Test setConsumeAs(Class); when 'java.lang.Object'; then throw IllegalArgumentException")
  @Tag("MaintainedByDiffblue")
   ...
   * </ul>
   * <p>
   * Method under test: {@link GafferMapFunction#flatMap(Object, Collector)}
   */
  @Test
