...
class IterableToHyperLogLogPlusDiffblueTest {
  ...
  @MethodsUnderTest({"void IterableToHyperLogLogPlus.<init>()", "void IterableToHyperLogLogPlus.<init>(int, int)",
      "int IterableToHyperLogLogPlus.getP()", "int IterableToHyperLogLogPlus.getSp()",
      "void IterableToHyperLogLogPlus.setP(int)", "void IterableToHyperLogLogPlus.setSp(int)"})
   ...
   */
  @Test
  @DisplayName("Test apply(Iterable) with 'Iterable'; given '42'; when ArrayList() add '42'; then return sizeof is twenty-four")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"HyperLogLogPlus IterableToHyperLogLogPlus.apply(Iterable)"})
  void testApplyWithIterable_given42_whenArrayListAdd42_thenReturnSizeofIsTwentyFour() throws IOException {
    // Arrange
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"HyperLogLogPlus IterableToHyperLogLogPlus.apply(Iterable)"})
  void testApplyWithIterable_given42_whenArrayListAdd42_thenReturnSizeofIsTwentyFour2() throws IOException {
    // Arrange
    IterableToHyperLogLogPlus iterableToHyperLogLogPlus = new IterableToHyperLogLogPlus();
   ...
   */
  @Test
  @DisplayName("Test apply(Iterable) with 'Iterable'; given empty string; when ArrayList() add empty string")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"HyperLogLogPlus IterableToHyperLogLogPlus.apply(Iterable)"})
   ...
   */
  @Test
  @DisplayName("Test apply(Iterable) with 'Iterable'; given 'foo'; when ArrayList() add 'foo'; then return sizeof is twenty-four")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"HyperLogLogPlus IterableToHyperLogLogPlus.apply(Iterable)"})
  void testApplyWithIterable_givenFoo_whenArrayListAddFoo_thenReturnSizeofIsTwentyFour() throws IOException {
    // Arrange
    IterableToHyperLogLogPlus iterableToHyperLogLogPlus = new IterableToHyperLogLogPlus();
   ...
   * Test {@link IterableToHyperLogLogPlus#apply(Iterable)} with {@code Iterable}.
   * <ul>
   *   <li>Given {@link IterableToHyperLogLogPlus#IterableToHyperLogLogPlus(int, int)} with p is five and sp is zero.</li>
   * </ul>
   * <p>
   * Method under test: {@link IterableToHyperLogLogPlus#apply(Iterable)}
   */
  @Test
  @DisplayName("Test apply(Iterable) with 'Iterable'; given IterableToHyperLogLogPlus(int, int) with p is five and sp is zero")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"HyperLogLogPlus IterableToHyperLogLogPlus.apply(Iterable)"})
  void testApplyWithIterable_givenIterableToHyperLogLogPlusWithPIsFiveAndSpIsZero() throws IOException {
    // Arrange
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"HyperLogLogPlus IterableToHyperLogLogPlus.apply(Iterable)"})
  void testApplyWithIterable_givenIterableToHyperLogLogPlusWithPIsFiveAndSpIsZero2() throws IOException {
    // Arrange
    IterableToHyperLogLogPlus iterableToHyperLogLogPlus = new IterableToHyperLogLogPlus(5, 0);
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"HyperLogLogPlus IterableToHyperLogLogPlus.apply(Iterable)"})
  void testApplyWithIterable_givenIterableToHyperLogLogPlusWithPIsFiveAndSpIsZero3() throws IOException {
    // Arrange
    IterableToHyperLogLogPlus iterableToHyperLogLogPlus = new IterableToHyperLogLogPlus(5, 0);
   ...
   * Test {@link IterableToHyperLogLogPlus#apply(Iterable)} with {@code Iterable}.
   * <ul>
   *   <li>Given {@link IterableToHyperLogLogPlus#IterableToHyperLogLogPlus()}.</li>
   ...
   */
  @Test
  @DisplayName("Test apply(Iterable) with 'Iterable'; given IterableToHyperLogLogPlus(); when ArrayList()")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"HyperLogLogPlus IterableToHyperLogLogPlus.apply(Iterable)"})
   ...
   */
  @Test
  @DisplayName("Test apply(Iterable) with 'Iterable'; given MIN_VALUE; when ArrayList() add MIN_VALUE")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"HyperLogLogPlus IterableToHyperLogLogPlus.apply(Iterable)"})
   ...
   */
  @Test
  @DisplayName("Test apply(Iterable) with 'Iterable'; given two; when ArrayList() add two; then return sizeof is twenty-four")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"HyperLogLogPlus IterableToHyperLogLogPlus.apply(Iterable)"})
  void testApplyWithIterable_givenTwo_whenArrayListAddTwo_thenReturnSizeofIsTwentyFour() throws IOException {
    // Arrange
    IterableToHyperLogLogPlus iterableToHyperLogLogPlus = new IterableToHyperLogLogPlus();
