...
class LongsSketchAggregatorDiffblueTest {
  /**
   * Test {@link LongsSketchAggregator#_apply(LongsSketch, LongsSketch)} with {@code LongsSketch}, {@code LongsSketch}.
   * <ul>
   *   <li>Given {@code null}.</li>
   *   <li>Then return {@link LongsSketch}.</li>
   * </ul>
   * <p>
   * Method under test: {@link LongsSketchAggregator#_apply(LongsSketch, LongsSketch)}
   */
  @Test
  @DisplayName("Test _apply(LongsSketch, LongsSketch) with 'LongsSketch', 'LongsSketch'; given 'null'; then return LongsSketch")
