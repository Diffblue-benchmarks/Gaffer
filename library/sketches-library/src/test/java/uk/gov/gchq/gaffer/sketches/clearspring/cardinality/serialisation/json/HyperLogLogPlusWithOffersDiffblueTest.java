...
class HyperLogLogPlusWithOffersDiffblueTest {
   ...
   *   <li>Then return sizeof is twenty-four.</li>
   * </ul>
   * <p>
   * Method under test: {@link HyperLogLogPlusWithOffers#getHyperLogLogPlus()}
   */
  @Test
  @DisplayName("Test getHyperLogLogPlus(); given ArrayList() add '42'; then return sizeof is twenty-four")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"HyperLogLogPlus HyperLogLogPlusWithOffers.getHyperLogLogPlus()"})
  void testGetHyperLogLogPlus_givenArrayListAdd42_thenReturnSizeofIsTwentyFour() throws IOException {
    // Arrange
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"HyperLogLogPlus HyperLogLogPlusWithOffers.getHyperLogLogPlus()"})
  void testGetHyperLogLogPlus_givenArrayListAdd42_thenReturnSizeofIsTwentyFour2() throws IOException {
    // Arrange
    ArrayList<Object> offers = new ArrayList<>();
    offers.add("42");
    offers.add("42");
   ...
   */
  @Test
  @DisplayName("Test getHyperLogLogPlus(); given ArrayList() add empty string; then return sizeof is twenty-four")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"HyperLogLogPlus HyperLogLogPlusWithOffers.getHyperLogLogPlus()"})
  void testGetHyperLogLogPlus_givenArrayListAddEmptyString_thenReturnSizeofIsTwentyFour() throws IOException {
    // Arrange
    ArrayList<Object> offers = new ArrayList<>();
    offers.add("");
   ...
   */
  @Test
  @DisplayName("Test getHyperLogLogPlus(); given ArrayList() add 'foo'; then return sizeof is twenty-four")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"HyperLogLogPlus HyperLogLogPlusWithOffers.getHyperLogLogPlus()"})
  void testGetHyperLogLogPlus_givenArrayListAddFoo_thenReturnSizeofIsTwentyFour() throws IOException {
    // Arrange
    ArrayList<Object> offers = new ArrayList<>();
    offers.add("foo");
   ...
   * Test {@link HyperLogLogPlusWithOffers#getHyperLogLogPlus()}.
   * <ul>
   *   <li>Given {@link ArrayList#ArrayList()} add {@link Integer#MIN_VALUE}.</li>
   *   <li>Then return sizeof is twenty-four.</li>
   * </ul>
   * <p>
   * Method under test: {@link HyperLogLogPlusWithOffers#getHyperLogLogPlus()}
   */
  @Test
  @DisplayName("Test getHyperLogLogPlus(); given ArrayList() add MIN_VALUE; then return sizeof is twenty-four")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"HyperLogLogPlus HyperLogLogPlusWithOffers.getHyperLogLogPlus()"})
  void testGetHyperLogLogPlus_givenArrayListAddMin_value_thenReturnSizeofIsTwentyFour() throws IOException {
    // Arrange
    ArrayList<Object> offers = new ArrayList<>();
   ...
   */
  @Test
  @DisplayName("Test getHyperLogLogPlus(); given ArrayList() add 'null'; then return sizeof is twenty-four")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"HyperLogLogPlus HyperLogLogPlusWithOffers.getHyperLogLogPlus()"})
  void testGetHyperLogLogPlus_givenArrayListAddNull_thenReturnSizeofIsTwentyFour() throws IOException {
    // Arrange
    ArrayList<Object> offers = new ArrayList<>();
    offers.add(null);
   ...
   */
  @Test
  @DisplayName("Test getHyperLogLogPlus(); given ArrayList() add two; then return sizeof is twenty-four")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"HyperLogLogPlus HyperLogLogPlusWithOffers.getHyperLogLogPlus()"})
  void testGetHyperLogLogPlus_givenArrayListAddTwo_thenReturnSizeofIsTwentyFour() throws IOException {
    // Arrange
    ArrayList<Object> offers = new ArrayList<>();
    offers.add(2);
   ...
   * Test {@link HyperLogLogPlusWithOffers#getHyperLogLogPlus()}.
   * <ul>
   *   <li>Given {@link HyperLogLogPlusWithOffers} (default constructor).</li>
   * </ul>
   * <p>
   * Method under test: {@link HyperLogLogPlusWithOffers#getHyperLogLogPlus()}
   */
   ...
   * Test {@link HyperLogLogPlusWithOffers#getHyperLogLogPlus()}.
   * <ul>
   *   <li>Given {@link HyperLogLogPlusWithOffers} (default constructor) Sp is zero.</li>
   * </ul>
   * <p>
   * Method under test: {@link HyperLogLogPlusWithOffers#getHyperLogLogPlus()}
   */
  @Test
  @DisplayName("Test getHyperLogLogPlus(); given HyperLogLogPlusWithOffers (default constructor) Sp is zero")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"HyperLogLogPlus HyperLogLogPlusWithOffers.getHyperLogLogPlus()"})
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void HyperLogLogPlusWithOffers.<init>()",
      "byte[] HyperLogLogPlusWithOffers.getHyperLogLogPlusSketchBytes()", "List HyperLogLogPlusWithOffers.getOffers()",
      "int HyperLogLogPlusWithOffers.getP()", "int HyperLogLogPlusWithOffers.getSp()",
      "void HyperLogLogPlusWithOffers.setHyperLogLogPlusSketchBytes(byte[])",
      "void HyperLogLogPlusWithOffers.setOffers(List)", "void HyperLogLogPlusWithOffers.setP(int)",
