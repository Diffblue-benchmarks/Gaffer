...
class SketchAggregatorDiffblueTest {
   ...
   * <ul>
   *   <li>Then return RetainedEntries is zero.</li>
   * </ul>
   * <p>
   * Method under test: {@link SketchAggregator#_apply(Sketch, Sketch)}
   */
  @Test
  @DisplayName("Test _apply(Sketch, Sketch) with 'Sketch', 'Sketch'; then return RetainedEntries is zero")
  ...
  void test_applyWithSketchSketch_thenReturnRetainedEntriesIsZero() {
    ...
    assertSame(actual_applyResult, actual_applyResult.compact());
  }
}
