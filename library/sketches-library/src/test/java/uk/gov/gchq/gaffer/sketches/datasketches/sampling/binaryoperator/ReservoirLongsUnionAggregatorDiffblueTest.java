...
class ReservoirLongsUnionAggregatorDiffblueTest {
  /**
   * Test {@link ReservoirLongsUnionAggregator#_apply(ReservoirLongsUnion, ReservoirLongsUnion)} with {@code ReservoirLongsUnion}, {@code ReservoirLongsUnion}.
   * <p>
   * Method under test: {@link ReservoirLongsUnionAggregator#_apply(ReservoirLongsUnion, ReservoirLongsUnion)}
   */
  @Test
  @DisplayName("Test _apply(ReservoirLongsUnion, ReservoirLongsUnion) with 'ReservoirLongsUnion', 'ReservoirLongsUnion'")
   ...
   */
  @Test
  @DisplayName("Test _apply(ReservoirLongsUnion, ReservoirLongsUnion) with 'ReservoirLongsUnion', 'ReservoirLongsUnion'; then return newInstance three")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
      "ReservoirLongsUnion ReservoirLongsUnionAggregator._apply(ReservoirLongsUnion, ReservoirLongsUnion)"})
  void test_applyWithReservoirLongsUnionReservoirLongsUnion_thenReturnNewInstanceThree() {
    ...
    // Act and Assert
    assertSame(a, reservoirLongsUnionAggregator._apply(a, ReservoirLongsUnion.newInstance(3)));
  }
}
