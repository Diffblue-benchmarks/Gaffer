...
class DoublesUnionAggregatorDiffblueTest {
  /**
   * Test {@link DoublesUnionAggregator#_apply(DoublesUnion, DoublesUnion)} with {@code DoublesUnion}, {@code DoublesUnion}.
   * <p>
   * Method under test: {@link DoublesUnionAggregator#_apply(DoublesUnion, DoublesUnion)}
   */
  @Test
