...
public class GafferPopGraphStepStrategyDiffblueTest {
  /**
   * Test {@link GafferPopGraphStepStrategy#apply(Admin)}.
   * <p>
   * Method under test: {@link GafferPopGraphStepStrategy#apply(Admin)}
   */
  @Test
   ...
   *   <li>Then calls {@link DefaultTraversal#getSteps()}.</li>
   * </ul>
   * <p>
   * Method under test: {@link GafferPopGraphStepStrategy#apply(Admin)}
   */
  ...
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"void GafferPopGraphStepStrategy.apply(Admin)"})
  public void testApply_givenArrayList_thenCallsGetSteps() {
    // Arrange
    GafferPopGraphStepStrategy instanceResult = GafferPopGraphStepStrategy.instance();
    DefaultGraphTraversal<?, ?> traversal = mock(DefaultGraphTraversal.class);
   ...
   * </ul>
   * <p>
   * Method under test: {@link GafferPopGraphStepStrategy#instance()}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
