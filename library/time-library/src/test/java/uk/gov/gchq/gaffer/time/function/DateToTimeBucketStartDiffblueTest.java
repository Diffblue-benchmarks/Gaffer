...
class DateToTimeBucketStartDiffblueTest {
  ...
  @MethodsUnderTest({"void DateToTimeBucketStart.<init>()", "void DateToTimeBucketStart.<init>(TimeBucket)",
      "TimeBucket DateToTimeBucketStart.getBucket()", "void DateToTimeBucketStart.setBucket(TimeBucket)"})
  ...
  void testGettersAndSetters_whenSecond() {
    // Arrange and Act
    DateToTimeBucketStart actualDateToTimeBucketStart = new DateToTimeBucketStart(TimeBucket.SECOND);
    actualDateToTimeBucketStart.setBucket(TimeBucket.SECOND);
   ...
   * </ul>
   * <p>
   * Method under test: {@link DateToTimeBucketStart#apply(Date)}
   */
  @Test
