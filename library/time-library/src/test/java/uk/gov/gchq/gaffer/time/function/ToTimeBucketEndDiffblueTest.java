...
class ToTimeBucketEndDiffblueTest {
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void ToTimeBucketEnd.<init>()",
    "void ToTimeBucketEnd.<init>(TimeBucket)",
    "TimeBucket ToTimeBucketEnd.getBucket()",
    "void ToTimeBucketEnd.setBucket(TimeBucket)"
  })
   ...
   *
   * <ul>
   *   <li>Then return longValue is {@code 59999}.
   * </ul>
   *
   * <p>Method under test: {@link ToTimeBucketEnd#apply(Long)}
   */
  @Test
  ...
  void testApplyWithLong_thenReturnLongValueIs59999() {
    ...
    assertEquals(59999L, new ToTimeBucketEnd(TimeBucket.MINUTE).apply(10L).longValue());
  }
   ...
   *
   * <ul>
   *   <li>Then return longValue is {@code 3599999}.
   * </ul>
   *
   * <p>Method under test: {@link ToTimeBucketEnd#apply(Long)}
   */
  ...
  void testApplyWithLong_thenReturnLongValueIs3599999() {
    // Arrange, Act and Assert
    assertEquals(3599999L, new ToTimeBucketEnd(TimeBucket.HOUR).apply(10L).longValue());
  }
   ...
   *
   * <ul>
   *   <li>Then return longValue is {@code 86399999}.
   * </ul>
   *
   * <p>Method under test: {@link ToTimeBucketEnd#apply(Long)}
   */
  ...
  void testApplyWithLong_thenReturnLongValueIs86399999() {
    // Arrange, Act and Assert
    assertEquals(86399999L, new ToTimeBucketEnd(TimeBucket.DAY).apply(10L).longValue());
  }
   ...
   *
   * <ul>
   *   <li>Then return longValue is {@code 345599999}.
   * </ul>
   *
   * <p>Method under test: {@link ToTimeBucketEnd#apply(Long)}
   */
  ...
  void testApplyWithLong_thenReturnLongValueIs345599999() {
    // Arrange, Act and Assert
    assertEquals(345599999L, new ToTimeBucketEnd(TimeBucket.WEEK).apply(10L).longValue());
  }
   ...
   *
   * <ul>
   *   <li>Then return longValue is {@code 2678399999}.
   * </ul>
   *
   * <p>Method under test: {@link ToTimeBucketEnd#apply(Long)}
   */
  ...
  void testApplyWithLong_thenReturnLongValueIs2678399999() {
    // Arrange, Act and Assert
    assertEquals(2678399999L, new ToTimeBucketEnd(TimeBucket.MONTH).apply(10L).longValue());
  }
   ...
   *
   * <ul>
   *   <li>Then return longValue is {@code 31535999999}.
   * </ul>
   *
   * <p>Method under test: {@link ToTimeBucketEnd#apply(Long)}
   */
  ...
  void testApplyWithLong_thenReturnLongValueIs31535999999() {
    // Arrange, Act and Assert
    assertEquals(31535999999L, new ToTimeBucketEnd(TimeBucket.YEAR).apply(10L).longValue());
  }
   ...
   *
   * <ul>
   *   <li>Then return longValue is nine hundred ninety-nine.
   * </ul>
   *
   * <p>Method under test: {@link ToTimeBucketEnd#apply(Long)}
   */
  ...
  void testApplyWithLong_thenReturnLongValueIsTen() {
    // Arrange, Act and Assert
    assertEquals(10L, new ToTimeBucketEnd(TimeBucket.MILLISECOND).apply(10L).longValue());
  }
}
