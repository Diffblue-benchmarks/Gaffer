...
class CommonTimeUtilDiffblueTest {
   ...
   * </ul>
   * <p>
   * Method under test: {@link CommonTimeUtil#timeToBucket(long, TimeBucket)}
   */
  @Test
   ...
   *   <li>Then return {@code -259200000}.</li>
   * </ul>
   * <p>
   * Method under test: {@link CommonTimeUtil#timeToBucket(long, TimeBucket)}
   */
   ...
   * </ul>
   * <p>
   * Method under test: {@link CommonTimeUtil#timeToBucketStart(long, TimeBucket)}
   */
  @Test
   ...
   * <ul>
   *   <li>When {@code DAY}.</li>
   *   <li>Then return {@code 86399999}.</li>
   * </ul>
   * <p>
   * Method under test: {@link CommonTimeUtil#timeToBucketEnd(long, TimeBucket)}
   */
  @Test
   ...
   * <ul>
   *   <li>When {@code HOUR}.</li>
   *   <li>Then return {@code 3599999}.</li>
   * </ul>
   * <p>
   * Method under test: {@link CommonTimeUtil#timeToBucketEnd(long, TimeBucket)}
   */
   ...
   * <ul>
   *   <li>When {@code MONTH}.</li>
   *   <li>Then return {@code 2678399999}.</li>
   * </ul>
   * <p>
   * Method under test: {@link CommonTimeUtil#timeToBucketEnd(long, TimeBucket)}
   */
   ...
   * <ul>
   *   <li>When {@code SECOND}.</li>
   *   <li>Then return nine hundred ninety-nine.</li>
   * </ul>
   * <p>
   * Method under test: {@link CommonTimeUtil#timeToBucketEnd(long, TimeBucket)}
   */
  @Test
  @DisplayName("Test timeToBucketEnd(long, TimeBucket); when 'SECOND'; then return nine hundred ninety-nine")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"long CommonTimeUtil.timeToBucketEnd(long, TimeBucket)"})
   ...
   * <ul>
   *   <li>When {@code WEEK}.</li>
   *   <li>Then return {@code 345599999}.</li>
   * </ul>
   * <p>
   * Method under test: {@link CommonTimeUtil#timeToBucketEnd(long, TimeBucket)}
   */
   ...
   * <ul>
   *   <li>When {@code YEAR}.</li>
   *   <li>Then return {@code 31535999999}.</li>
   * </ul>
   * <p>
   * Method under test: {@link CommonTimeUtil#timeToBucketEnd(long, TimeBucket)}
   */
