...
class ReservoirLongsSketchKryoSerializerDiffblueTest {
   ...
   * <p>
   * Method under test: default or parameterless constructor of {@link ReservoirLongsSketchKryoSerializer}
   */
  @Test
  ...
  void testNewReservoirLongsSketchKryoSerializer() {
    // Arrange and Act
    ReservoirLongsSketchKryoSerializer actualReservoirLongsSketchKryoSerializer = new ReservoirLongsSketchKryoSerializer();
