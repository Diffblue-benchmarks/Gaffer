...
class StringsSketchKryoSerializerDiffblueTest {
   ...
   * <p>
   * Method under test: default or parameterless constructor of {@link StringsSketchKryoSerializer}
   */
  @Test
  ...
  void testNewStringsSketchKryoSerializer() {
    // Arrange and Act
    StringsSketchKryoSerializer actualStringsSketchKryoSerializer = new StringsSketchKryoSerializer();
