...
class TypeReferenceSparkImplDiffblueTest {
   ...
   * <p>
   * Method under test: default or parameterless constructor of {@link DataSetRow}
   */
  @Test
  ...
  void testDataSetRowNewDataSetRow() {
    ...
    assertEquals("org.apache.spark.sql.Dataset<org.apache.spark.sql.Row>", (new DataSetRow()).getType().getTypeName());
  }

  /**
   * Test IterableRowT new {@link IterableRowT} (default constructor).
   * <p>
   * Method under test: default or parameterless constructor of {@link IterableRowT}
   */
  @Test
   ...
   * <p>
   * Method under test: default or parameterless constructor of {@link JavaRDDElement}
   */
  @Test
   ...
   * <p>
   * Method under test: default or parameterless constructor of {@link RDDElement}
   */
  @Test
