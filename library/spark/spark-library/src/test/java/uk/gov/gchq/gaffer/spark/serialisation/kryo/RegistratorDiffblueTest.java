...
class RegistratorDiffblueTest {
  ...
  @Test
  @DisplayName(
      "Test registerClasses(Kryo); given 'java.lang.Object'; then Kryo() NextRegistrationId is twenty-five")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void Registrator.registerClasses(Kryo)"})
  void testRegisterClasses_givenJavaLangObject_thenKryoNextRegistrationIdIsTwentyFive() {
    // Arrange
    Registrator registrator = new Registrator();
