...
class TypeSubTypeValueKryoSerializerDiffblueTest {
   ...
   * <p>
   * Method under test: default or parameterless constructor of {@link TypeSubTypeValueKryoSerializer}
   */
  @Test
  @DisplayName("Test new TypeSubTypeValueKryoSerializer (default constructor)")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void TypeSubTypeValueKryoSerializer.<init>()"})
  void testNewTypeSubTypeValueKryoSerializer() {
    // Arrange and Act
    TypeSubTypeValueKryoSerializer actualTypeSubTypeValueKryoSerializer = new TypeSubTypeValueKryoSerializer();
