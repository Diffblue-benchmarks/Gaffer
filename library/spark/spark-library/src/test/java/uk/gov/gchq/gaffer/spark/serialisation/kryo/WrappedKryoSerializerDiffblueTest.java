...
class WrappedKryoSerializerDiffblueTest {
   ...
   * <ul>
   *   <li>When {@link Output} {@link Output#writeBytes(byte[])} does nothing.</li>
   *   <li>Then calls {@link HyperLogLogPlus#getBytes()}.</li>
   * </ul>
   * <p>
   * Method under test: {@link WrappedKryoSerializer#write(Kryo, Output, Object)}
   */
  @Test
  @DisplayName("Test write(Kryo, Output, Object); when Output writeBytes(byte[]) does nothing; then calls getBytes()")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void WrappedKryoSerializer.write(Kryo, Output, Object)"})
  void testWrite_whenOutputWriteBytesDoesNothing_thenCallsGetBytes() throws KryoException, IOException {
    // Arrange
    HyperLogLogPlusKryoSerializer hyperLogLogPlusKryoSerializer = new HyperLogLogPlusKryoSerializer();
    Kryo kryo = new Kryo();
    ...
    verify(output).writeInt(eq(8));
  }

  /**
   * Test {@link WrappedKryoSerializer#equals(Object)}, and {@link WrappedKryoSerializer#hashCode()}.
   * <ul>
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"boolean WrappedKryoSerializer.equals(Object)", "int WrappedKryoSerializer.hashCode()"})
   ...
   * </ul>
   * <p>
   * Method under test: {@link WrappedKryoSerializer#equals(Object)}
   */
  @Test
