...
class HyperLogLogPlusKryoSerializerDiffblueTest {
   ...
   * <p>
   * Method under test: default or parameterless constructor of {@link HyperLogLogPlusKryoSerializer}
   */
  @Test
  ...
  void testNewHyperLogLogPlusKryoSerializer() {
    // Arrange and Act
    HyperLogLogPlusKryoSerializer actualHyperLogLogPlusKryoSerializer = new HyperLogLogPlusKryoSerializer();
