...
class AbstractGetRDDHandlerDiffblueTest {
  ...
  void testAddIterators() throws IteratorSettingException, OperationException, StoreException {
    // Arrange
   ...
   */
  @Test
  @DisplayName("Test getConfiguration(Output); given '42'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"Configuration AbstractGetRDDHandler.getConfiguration(Output)"})
   ...
   *
   * <ul>
   *   <li>Given {@code uk.gov.gchq.gaffer.commonutil.Required}.
   * </ul>
   *
   * <p>Method under test: {@link AbstractGetRDDHandler#getConfiguration(Output)}
   */
  @Test
  @DisplayName("Test getConfiguration(Output); given 'uk.gov.gchq.gaffer.commonutil.Required'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"Configuration AbstractGetRDDHandler.getConfiguration(Output)"})
  void testGetConfiguration_givenUkGovGchqGafferCommonutilRequired() throws OperationException {
    // Arrange
    GetJavaRDDOfAllElementsHandler getJavaRDDOfAllElementsHandler =
        new GetJavaRDDOfAllElementsHandler();
    ...
    GetJavaRDDOfAllElements getJavaRDDOfAllElements = new GetJavaRDDOfAllElements();
    getJavaRDDOfAllElements.addOption(
        AbstractGetRDDHandler.HADOOP_CONFIGURATION_KEY, "uk.gov.gchq.gaffer.commonutil.Required");
