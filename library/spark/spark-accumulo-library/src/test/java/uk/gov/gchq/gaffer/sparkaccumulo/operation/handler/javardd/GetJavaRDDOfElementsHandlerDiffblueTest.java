...
class GetJavaRDDOfElementsHandlerDiffblueTest {
  /**
   * Test {@link GetJavaRDDOfElementsHandler#doOperation(GetJavaRDDOfElements, Context, Store)} with
   ...
   * </ul>
   *
   * <p>Method under test: {@link GetJavaRDDOfElementsHandler#doOperation(GetJavaRDDOfElements,
   * Context, Store)}
   */
  @Test
  @DisplayName(
      "Test doOperation(GetJavaRDDOfElements, Context, Store) with 'operation', 'context', 'store'; given 'Option'; then throw OperationException")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "org.apache.spark.api.java.JavaRDD GetJavaRDDOfElementsHandler.doOperation(GetJavaRDDOfElements, Context, Store)"
  })
  void testDoOperationWithOperationContextStore_givenOption_thenThrowOperationException()
      throws OperationException {
    // Arrange
    GetJavaRDDOfElementsHandler getJavaRDDOfElementsHandler = new GetJavaRDDOfElementsHandler();

    GetJavaRDDOfElements operation = mock(GetJavaRDDOfElements.class);
    ...
    assertThrows(
        ...
        () -> getJavaRDDOfElementsHandler.doOperation(operation, context, store));
