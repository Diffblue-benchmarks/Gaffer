...
class ExampleDomainObjectDiffblueTest {
  ...
  @MethodsUnderTest({"void ExampleDomainObject.<init>()", "void ExampleDomainObject.<init>(String, Object[])",
      "Object[] ExampleDomainObject.getIds()", "String ExampleDomainObject.getType()",
      "void ExampleDomainObject.setIds(Object[])", "void ExampleDomainObject.setType(String)"})
