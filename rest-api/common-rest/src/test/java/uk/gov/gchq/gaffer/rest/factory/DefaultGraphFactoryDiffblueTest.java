...
class DefaultGraphFactoryDiffblueTest {
   ...
   * <p>
   * Method under test: {@link DefaultGraphFactory#createGraphFactory()}
   */
  @Test
   ...
   * <p>
   * Method under test: {@link DefaultGraphFactory#getSchemaPaths()}
   */
  @Test
   ...
   * <ul>
   *   <li>Given {@link DefaultGraphFactory} (default constructor).</li>
   * </ul>
   * <p>
   * Method under test: {@link DefaultGraphFactory#getGraph()}
   */
  @Test
   ...
   * Test {@link DefaultGraphFactory#getGraph()}.
   * <ul>
   *   <li>Given {@link DefaultGraphFactory} (default constructor) SingletonGraph is {@code false}.</li>
   * </ul>
   * <p>
   * Method under test: {@link DefaultGraphFactory#getGraph()}
   */
  @Test
  @DisplayName("Test getGraph(); given DefaultGraphFactory (default constructor) SingletonGraph is 'false'")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"uk.gov.gchq.gaffer.graph.Graph DefaultGraphFactory.getGraph()"})
   ...
   * <p>
   * Method under test: {@link DefaultGraphFactory#createGraphBuilder()}
   */
  @Test
  @DisplayName("Test createGraphBuilder()")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"uk.gov.gchq.gaffer.graph.Graph.Builder DefaultGraphFactory.createGraphBuilder()"})
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void DefaultGraphFactory.<init>()", "boolean DefaultGraphFactory.isSingletonGraph()",
