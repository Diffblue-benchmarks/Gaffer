...
class SystemStatusDiffblueTest {
  ...
  @MethodsUnderTest({"void SystemStatus.<init>(Status)", "Status SystemStatus.getStatus()",
  ...
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(expectedHashCodeResult, systemStatus2.hashCode());
  }
   ...
   * </ul>
   * <p>
   * Method under test: {@link SystemStatus#equals(Object)}
   */
  @Test
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"String Status.getCode()", "String Status.getDescription()", "String Status.toString()"})
