...
class PropertiesUtilDiffblueTest {
   ...
   * <p>
   * Method under test: {@link PropertiesUtil#getProperties()}
   */
  @Test
  ...
  void testGetProperties() {
    ...
    assertEquals(SystemProperty.APP_DESCRIPTION_DEFAULT, actualProperties.get(SystemProperty.APP_DESCRIPTION));
    assertEquals(SystemProperty.APP_DOCUMENTATION_URL_DEFAULT,
    ...
    assertEquals(SystemProperty.GAFFER_VERSION_DEFAULT, actualProperties.get(SystemProperty.GAFFER_VERSION));
    assertEquals(SystemProperty.KORYPHE_VERSION_DEFAULT, actualProperties.get(SystemProperty.KORYPHE_VERSION));
    assertEquals(SystemProperty.LOGO_IMAGE_URL_DEFAULT, actualProperties.get(SystemProperty.FAVICON_LARGE_URL));
    assertEquals(SystemProperty.LOGO_IMAGE_URL_DEFAULT, actualProperties.get(SystemProperty.FAVICON_SMALL_URL));
    assertEquals(SystemProperty.LOGO_IMAGE_URL_DEFAULT, actualProperties.get(SystemProperty.LOGO_IMAGE_URL));
   ...
   * <p>
   * Method under test: {@link PropertiesUtil#getProperty(String)}
   */
  @Test
