...
class OperationFieldDiffblueTest {
  ...
  @MethodsUnderTest({"void OperationField.<init>(String, String, String, Set, boolean)",
      "String OperationField.getClassName()", "String OperationField.getName()", "Set OperationField.getOptions()",
      "String OperationField.getSummary()", "boolean OperationField.isRequired()", "String OperationField.toString()"})
  void testGettersAndSetters() {
    ...
    assertEquals("OperationField[name=Name,summary=Summary,className=Class Name,options=[],required=true]",
