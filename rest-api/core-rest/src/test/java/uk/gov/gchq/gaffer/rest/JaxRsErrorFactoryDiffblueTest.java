...
class JaxRsErrorFactoryDiffblueTest {
   ...
   * </ul>
   * <p>
   * Method under test: {@link JaxRsErrorFactory#from(WebApplicationException)}
   */
  @Test
  @DisplayName("Test from(WebApplicationException); then return SimpleMessage is 'An error occurred'")
  ...
  void testFrom_thenReturnSimpleMessageIsAnErrorOccurred() {
    // Arrange and Act
    Error actualFromResult = JaxRsErrorFactory.from(new WebApplicationException("An error occurred"));
   ...
   * Test {@link JaxRsErrorFactory#from(WebApplicationException)}.
   * <ul>
   *   <li>Then return SimpleMessage is {@code HTTP 500 Internal Server Error}.</li>
   * </ul>
   * <p>
   * Method under test: {@link JaxRsErrorFactory#from(WebApplicationException)}
   */
  @Test
  @DisplayName("Test from(WebApplicationException); then return SimpleMessage is 'HTTP 500 Internal Server Error'")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"Error JaxRsErrorFactory.from(WebApplicationException)"})
