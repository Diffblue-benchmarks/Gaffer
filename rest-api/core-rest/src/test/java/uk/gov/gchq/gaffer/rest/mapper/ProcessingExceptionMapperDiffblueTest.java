...
class ProcessingExceptionMapperDiffblueTest {
  /**
   * Test {@link ProcessingExceptionMapper#toResponse(ProcessingException)} with {@code ProcessingException}.
   * <p>
   * Method under test: {@link ProcessingExceptionMapper#toResponse(ProcessingException)}
   */
  @Test
  @DisplayName("Test toResponse(ProcessingException) with 'ProcessingException'")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"javax.ws.rs.core.Response ProcessingExceptionMapper.toResponse(ProcessingException)"})
  void testToResponseWithProcessingException() {
    ...
    // Act and Assert
    assertThrows(GafferRuntimeException.class,
