...
class ExamplesServiceV2DiffblueTest {
  ...
  @InjectMocks
  private ExamplesServiceV2 examplesServiceV2;

  /**
   * Test {@link ExamplesServiceV2#execute()}.
   * <ul>
   *   <li>Then throw {@link InstantiationException}.</li>
   * </ul>
   * <p>
   * Method under test: {@link ExamplesServiceV2#execute()}
   */
  @Test
  @DisplayName("Test execute(); then throw InstantiationException")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"Operation ExamplesServiceV2.execute()"})
  void testExecute_thenThrowInstantiationException() throws IllegalAccessException, InstantiationException {
    // Arrange
    when(examplesFactory.generateExample(Mockito.<Class<Operation>>any())).thenThrow(new InstantiationException("foo"));
   ...
   * </ul>
   * <p>
   * Method under test: {@link ExamplesServiceV2#executeChunked()}
   */
  @Test
  ...
  void testExecuteChunked_thenThrowInstantiationException() throws IllegalAccessException, InstantiationException {
    // Arrange
    when(examplesFactory.generateExample(Mockito.<Class<Operation>>any())).thenThrow(new InstantiationException("foo"));
