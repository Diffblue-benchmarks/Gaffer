...
class JobServiceDiffblueTest {
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "uk.gov.gchq.gaffer.jobtracker.JobDetail JobService.executeJob(OperationChainDAO)"
  })
  ...
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"uk.gov.gchq.gaffer.jobtracker.JobDetail JobService.details(String)"})
