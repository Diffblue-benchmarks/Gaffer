...
class VersionControllerDiffblueTest {
   ...
   * <p>
   * Method under test: {@link VersionController#getGafferVersion()}
   */
  @Test
  ...
  void testGetGafferVersion() throws Exception {
    // Arrange
    MockHttpServletRequestBuilder requestBuilder = MockMvcRequestBuilders.get("/rest/graph/version");
    ...
    MockMvcBuilders.standaloneSetup(versionController)
        ...
        .andExpect(MockMvcResultMatchers.content().string("2.3.3-SNAPSHOT"));
  }
}
